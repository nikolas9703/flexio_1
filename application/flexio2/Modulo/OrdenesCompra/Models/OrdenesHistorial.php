...
class OrdenesHistorial extends Model{
    protected $table = 'ord_ordenes_historial';
	protected $fillable = ['codigo','descripcion','empresa_id','usuario_id','orden_id','antes','despues','tipo','codigo_cuenta'];
