  ...
  public function get($clause = array(), $sidx = null, $sord = null, $limit = null, $start = null)
    {
        ...
        if($sidx !== null && $sord !== null){$politicasTransacciones->orderBy($sidx, $sord);}
        if($limit != null){$politicasTransacciones->skip($start)->take($limit);}
