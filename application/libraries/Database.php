...
class Database{
	...
	private $db_name = "crmcorcione";	// Change as required
     ...
     * @return	string
     */
    function csv_from_result($sql, $delim = ",", $newline = "\n", $enclosure = '"')
    {
    	if ( ! is_object($sql) OR ! method_exists($sql, 'list_fields'))
    	{
    	...
    	foreach ($sql->list_fields() as $name)
    	{
    	...
    	foreach ($sql->result_array() as $row)
    	{
    		foreach ($row as $item)
    		{
    			$item = trim(strip_tags(ucwords (mb_strtolower(Util::limpiar_cadena_texto($item)))));
