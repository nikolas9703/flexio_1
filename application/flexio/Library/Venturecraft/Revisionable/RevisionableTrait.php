<?php namespace Flexio\Library\Venturecraft\Revisionable;
...
trait RevisionableTrait
{
    ...
    public function postSave()
    {
        ...
        if (((!isset($this->revisionEnabled) || $this->revisionEnabled) && $this->updating) && (!$LimitReached || $RevisionCleanup)) {
            ...
            if (count($revisions) > 0) {
                ...
                //self::$events->fire('revisionable.saved', array('model' => $this, 'revisions' => $revisions));
            }
        }
    }
    ...
    */
    ...
    {
        try {
            if (class_exists($class = 'Flexio\Library\Util\AuthUser')) {
                return ($class::getUser()) ? $class::getUser()->id : null;
            }
