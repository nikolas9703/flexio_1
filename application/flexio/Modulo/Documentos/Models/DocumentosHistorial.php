...
class DocumentosHistorial extends Model{
    protected $table = 'doc_documentos_historial';
	protected $fillable = ['codigo','descripcion','empresa_id','usuario_id','documento_id','antes','despues','tipo','codigo_cuenta'];
