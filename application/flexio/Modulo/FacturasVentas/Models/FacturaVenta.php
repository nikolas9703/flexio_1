...
class FacturaVenta extends Model
{
    ...
    public function termino_pago2() {
    	return $this->belongsTo(FacturaVentaCatalogo::class, "termino_pago", "etiqueta");
    }
...
//////////////////////////////////////////////////////////////
    function cobros() {
      return $this->belongsToMany(Cobro::class,'cob_cobro_facturas','cobrable_id','cobro_id')->where('cobrable_type','Flexio\Modulo\FacturasVentas\Models\FacturaVenta')
