...
namespace Flexio\Modulo\FacturasVentas\FormRequest;
...
class GuardarFacturaVenta{
    ...
    function crear($campos, $items, $items_alquiler){
        return  Capsule::transaction(function() use($campos, $items, $items_alquiler){
            ...
            $factura = FacturaVenta::create($campos);
            //2. salvar empezable;
    ...
    function actualizar($campos, $items, $items_alquiler){
        return  Capsule::transaction(function() use($campos, $items, $items_alquiler){
            ...
            //1. se crea la factura
            $factura = FacturaVenta::find($campos['id']);
    ...
    function orden_venta($modelo, $empezable_id){
        ...
        [
         ...
         'Flexio\Modulo\FacturasVentas\Listeners\OrdenVentaEstadoListener');
    ...
    function getLastCodigo(){
        ...
        $factura = FacturaVenta::where($clause)->get()->last();
