...
class FacturaSeguroRepositorio{
    ...
    function conIdPoliza($id){
        $this->builder->where('fac_facturas.id_poliza',$id);
        return $this;
    }
