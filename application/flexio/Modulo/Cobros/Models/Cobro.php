...
use Flexio\Modulo\Cobros\Comando\CobroEstadoManipulado;
...
class Cobro extends Model
{
    ...
    protected $fillable = ['codigo','cliente_id','empresa_id','fecha_pago','estado','monto_pagado','referencia','tipo','formulario','depositable_id', 'depositable_type','empezable_type','empezable_id'];
    ...
    public function factura_cobros(){
        return $this->belongsToMany(FacturaVenta::class,'cob_cobro_facturas','cobro_id','cobrable_id')->where('cobrable_type','Flexio\Modulo\FacturasVentas\Models\FacturaVenta')->withPivot('monto_pagado','empresa_id')->withTimestamps();
    }
...
/*    public function total_cobrado(){
    ...
    {
    	return base_url("cobros/ver/".$this->uuid_cobro);
    }
   ...
   public function present() {
       return new \Flexio\Modulo\Cobros\Presenter\CobroPresenter($this);
   }
