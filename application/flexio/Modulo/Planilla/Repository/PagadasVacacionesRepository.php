...
class PagadasVacacionesRepository{
...
private function  collection_tabla_descuentos($info){
 ...
 private function  collection_tabla_pagadas_colaborador($info){
     ...
     return  array(
      ...
      'uuid_colaborador' =>hex2bin($info['uuid_colaborador']),
      ...
      'contrato_id' =>isset($info['colaboradores_contratos'][0]['id'])?$info['colaboradores_contratos'][0]['id']:0,
