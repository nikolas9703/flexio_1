<?php echo form_open_multipart(base_url('endosos/ajax_guardar_documentos'), "id='guardarDocumento'"); ?>
<input type="hidden" name="id_endoso" id="id_endoso" value="" />
	...
	<div class="row docentregados">
		...
		<div class="row botones">
			...
			<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" >
				<br><br><br>
				<input type="submit" name="campo[guardar]" value="Guardar " class="btn btn-primary btn-block guardarEndoso" id="campo[guardar]" />
			</div>
		</div>
