<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg row">
	    ...
	    <!-- CONTENT WRAPPER -->
	    	...
	    	<div class="row">
				<?php if (Auth::has_module_access("proyectos")): ?>
							...
							<div class="row">
								<div class="col-sm-3">
									<p class="pull-left" style="margin-right:10px;">
										<i class="fa fa fa-cubes fa-5x"></i>
									</p>
								</div>
								<div class="col-sm-9">
									 <h3 class="m-t-none m-b">Administración de Proyectos</h3> 
				...
				<?php endif; ?>
				<?php if (Auth::has_module_access("propiedades")): ?>
   			 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
					<div class="ibox float-e-margins">
						<div class="ibox-content">
							<div class="row">
...
Administración de Propiedades</h3> 
									<p>Habilitar/Deshabilitar Campos y Definir Obligatorios.</p>
								</div>
							</div>
						</div>
