...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
      <label for="fecha_desde">Fecha de pago <span required="" aria-required="true">*</span></label>
      <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
          <input type="text" name="campo[fecha_pago]" class="form-control"  id="fecha_pago" data-rule-required="true" value="" ng-model="datosPago.fecha_pago" ng-disabled="vista=='ver'" data-rule-required="true">
    </div>
    ...
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <label for="proveedor_id">Estado </label>
        <select name="campo[estado]" id="estado" ng-model="datosPago.estado" ng-disabled="disabledEditar" class="form-control">
            <option value="">Seleccione</option>
  ...
  <!-- <div style="display:table-cell;"> -->
   <table class="table" id="facturaItems">
    ...
    <td><div class="input-group">
            <span class="input-group-addon">$</span><input type="text" id="precio_total{{$index}}" name="items[{{$index}}][monto_pagado]" class="form-control precio_total"  ng-model="factura.precio_total" ng-click="focusPago($index)" ng-change="cambiarCantidad($index,factura.precio_total)" ng-disabled="vista=='ver'" data-inputmask="'mask':'9{1,6}[.*{1,2}]'" placeholder="0.00"/></div>
    </td>
    </tr>
    </tbody>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
    ...
    <input type="text" id="monto" name="monto" ng-model="datosPago.monto" class="form-control"  disabled/></div>
  </div>
  <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
    <label>Pagar a Cuenta de Banco <span required="" aria-required="true">*</span></label>
  </div>
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      ...
      <select name="campo[cuenta_id]" ng-model="datosPago.cuenta_id" class="form-control" id="cuenta" data-rule-required="true"  ng-disabled="disableCuenta">
        <option value="">Seleccione</option>
        <?php
        foreach($cuenta_bancos as $banco){
        ?>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 item-listing lists_opciones" id="opciones{{$index}}"  ng-repeat="pago in opcionPagos track by $index">
  <div class="lists_opciones" id="opcionesRow{{$index}}">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <select class="form-control" name="metodo_pago[{{$index}}][tipo_pago]" id="tipo_pago{{$index}}" ng-model="pago.tipo_pago" ng-change="selecionePago($index, pago.tipo_pago)" ng-disabled="vista=='ver'" data-rule-required="true">
        <option value="">Seleccione</option>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      ...
      <div class="input-group"><span class="input-group-addon">$</span>
          <input type="text" id="total_pagado{{$index}}" name="metodo_pago[{{$index}}][total_pagado]" ng-model="pago.total_pagado" class="form-control" ng-change="sumaTotales($index)" ng-disabled="vista=='ver'" data-rule-required="true" data-inputmask="'mask':'9{1,6}[.*{2}]'" placeholder="0.00"/>
        </div>
  ...
  <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding" ng-show="pago.tipo_pago ==='ach'" ng-class="pagoClass($index)">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <select name="metodo_pago[{{$index}}][nombre_banco_ach]" id="nombre_banco_ach{{$index}}" class="form-control" ng-disabled="vista=='ver'">
                <option value=""></option>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 last-input">
      <input type="text" name="metodo_pago[{{$index}}][cuenta_proveedor]" id="cuenta_proveedor{{$index}}" class="form-control" ng-disabled="vista=='ver'"/>
    </div>
  </div>
  ...
  <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding" ng-show="pago.tipo_pago ==='tarjeta_de_credito'" ng-class="pagoClass($index)">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <input type="text" name="metodo_pago[{{$index}}][numero_tarjeta]" id="numero_tarjeta{{$index}}" class="form-control" ng-disabled="vista=='ver'"/>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <label>Número de recibo</label>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 last-input">
      <input type="text" name="metodo_pago[{{$index}}][numero_recibo]" id="numero_recibo{{$index}}" class="form-control" ng-disabled="vista=='ver'"/>
    </div>
  </div>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 last-div">
    ...
    <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
      <a href="<?php echo base_url('pagos/listar');?>" class="btn btn-default btn-block" id="cancelarFormBtn">Cancelar </a>
    </div>
    <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
      <input type="hidden" name="campo[id]" id="cobro_id" value="{{datosPago.id}}" ng-disabled="datosPago.id ===''"/>
