<template id="form_impuesto_sobre_itbms">
  <validator name="validar">
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="form-group col-lg-3">
        <label for="provedor_id">Proveedor <span required="" aria-required="true">*</span></label>
<select id="proveedores" class="white-bg select2" name="proveedor" v-selecttwo="reporte.proveedor" v-validate:proveedor="{required: { rule: true, initial: 'on' }}">
<option value=""></option>
</select>
<input type="hidden" value="" name="pdf" id="pdf" />
    </div>
...
<div class="form-inline">
    ...
    <div class="form-group col-lg-3">
        <label for="impuesto">Impuesto <span required="" aria-required="true">*</span></label>
        <select name="impuesto" class="form-control " id="impuesto" disabled>
          <option value="itbms" selected>I.T.B.M.S.</option>
          </select>
