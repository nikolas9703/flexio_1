				...
				<div role="tabpanel">
				 	<!-- Tab panes -->
                      ...
                      <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                          <label for="nombre">No. Orden de Venta</label>
                          <input type="text" id="no_orden" class="form-control" value="">
                      </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                          ...
                          <select name="estados" class="form-control" id="etapa">
				    		...
				    		<!-- JQGRID -->
				    		<?php echo modules::run('ordenes_alquiler/ocultotabla'); ?>
