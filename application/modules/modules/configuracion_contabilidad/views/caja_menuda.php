<table id="caja_menuda" class="table table-striped">
  <thead>
    <tr>
...
<div class="row">
  ...
  <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6"><button id="guardarBtn" class="btn btn-block btn-primary ladda-button" data-style="zoom-in">Guardar</button></div>
</div>
