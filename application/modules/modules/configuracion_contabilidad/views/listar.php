        	...
        	<div class="wrapper-content">
              ...
              <div class="row">
				...
				<div class="tab-content row" ng-controller="configImpuestoController">
                     ...
                     <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
                       <label for="">Cuentas tipo: Pasivo1</label>
                        <select data-placeholder="Seleccione" name="cuenta_id" id="cuenta_id" class="form-control chosen-select" ng-model="impuesto.cuenta_id">
                          <opction value=""></option>
                     ...
                     <div class="row">
                       <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
                         <label for="">Retiene Impuesto</label>
                          <select data-placeholder="Seleccione" name="cuenta_id" id="cuenta_id" class="form-control chosen-select" ng-model="impuesto.retiene_impuesto">
                            <opction value="no">No</option>
                            <opction value="si">S&iacute;</option>
                          </select>
                       </div>
                       <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
