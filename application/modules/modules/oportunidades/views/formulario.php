...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
        ...
        <select data-placeholder="Seleccione" name="campo[cliente_id]" class="form-control chosen-select" required="" data-rule-required="true" v-select2="oportunidad.empezar_desde_id" :disabled="config.vista == 'editar' || oportunidad.empezar_desde_type == '' || disabledHeader || disabledEditar">
    ...
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
        ...
        <select data-placeholder="Seleccione" name="campo[asignado_a_id]" class="form-control chosen-select" data-rule-required="true" v-select2="oportunidad.asignado_a_id" :disabled="disabledEditar">
            <option value="">Seleccione</option>
    ...
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <label for="etapa_id">Estado <span required="" aria-required="true">*</span></label>
        <select data-placeholder="Seleccione" name="campo[etapa_id]" class="form-control chosen-select" required="" data-rule-required="true" v-select2="oportunidad.etapa_id" :disabled="disabledEstado || disabledEditar">
            <option value="">Seleccione</option>
