  ...
  <div id="formulari3333o" class="panel-group">
                 	  ...
                 	  <div id="formulari3333o" class="panel-group">
                        ...
                        <div class="ibox-content">
                         ...
                         <!-- JQGRID -->
				    		<?php echo modules::run('planilla/ocultotablaingresosliquidacion'); ?>
                        ...
                        <div class="ibox-content">
				    		...
				    		<?php echo modules::run('planilla/ocultotabladeduccionesliquidacion'); ?>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
				    		...
				    		<?php  echo modules::run('planilla/ocultotabladescuentosdirectosliquidaciones'); ?>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                          ...
                          <?php echo modules::run('planilla/ocultotablacalculosliquidacion'); ?>
