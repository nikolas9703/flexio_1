            ...
            <div class="row rowhigth" ng-show="acceso">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-3" style="margin-bottom: 0px ! important;">
                        <select  class="form-control" name="tipo" id="tipo" ng-model="tipo" ng-change="ngChanged.empezarDesde(tipo)">
                    ...
                    <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-3" style="margin-bottom: 0px ! important;">
                        <!--las operaciones tiene un arreglo de las ordenes de compra y los contratos
                        que son facturables 18:compra y 19:subcontrato-->
                        <select  class="form-control" name="uuid_tipo" id="uuid_tipo" ng-model="uuid_tipo" ng-disabled="tipo ===''" ng-change="ngChanged.empezarDesdeId(tipo, uuid_tipo)">
                            <option value="">Seleccione</option>
                            <?php
                            foreach ($operaciones as  $operacion) {?>
                            <option value="<?php echo $operacion["registro"]->id?>" ng-show="<?php echo ($operacion["tipo"] == "orden_compra") ? "tipo=='Ordenes_orm'" : "tipo=='Subcontratos'"?>"><?php echo $operacion["registro"]->proveedor->nombre.' - '. $operacion["registro"]->numero_documento?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
