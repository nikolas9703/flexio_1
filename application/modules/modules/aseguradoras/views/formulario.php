    ...
    <div class="tab-content">
        ...
        <div id="datosdelaaseguradora-5" class="col-lg-12">
                                ...
                                if ($campos['politicas_general'] > 0) {
                                    if ($campos['uuid_aseguradora'] != "") {
                                        if ($campos['estado'] == "Por aprobar") {
                                            if (((in_array(8, $campos['politicas'])===false)&&(in_array(8, $campos['politicas_generales'])===false))|| (in_array(8, $campos['politicas'])===true)) {
                                                ?>
                                            ...
                                            if (((in_array(9, $campos['politicas'])===false)&&(in_array(9, $campos['politicas_generales'])===false))|| (in_array(9, $campos['politicas'])===true)) {
                                                ?>
                                                <option value='Activo' <?php echo $activo ?> >Activo</option>
                                            ...
                                            if (((in_array(10, $campos['politicas'])===false)&&(in_array(10, $campos['politicas_generales'])===false))|| (in_array(10, $campos['politicas'])===true)) {
                                                ?>
                                                <option value='Activo' <?php echo $activo ?> >Activo</option>
                                                <option value='Inactivo' <?php echo $inactivo ?> >Inactivo</option>
                                                <?php
            ...
            <div class="row"> <div class="col-xs-0 col-sm-6 col-md-8 col-lg-8">&nbsp;</div>
                <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2"><a href="<?php if($campos['ingreso'] != '' && $campos['ingreso'] == 'endosos' ){echo base_url('endosos/listar');}else{echo base_url('aseguradoras/listar');} ?>" class="btn btn-default btn-block" id="cancelar">Cancelar </a> </div>
