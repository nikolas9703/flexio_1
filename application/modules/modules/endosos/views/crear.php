                    ...
                    <div class="ibox-content" style="display: block;">
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>Ramo:</label>
                                <select id="id_ramo_endoso" name="campos[id_ramo]" class="form-control id_ramo" ><!-- onchange="verpolizas(1)" -->
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-5 col-lg-5">
                                <label>Cliente: </label>
                                <select id="cliente_id_endoso" name="campos[cliente_id]" class="form-control cliente_id" ><!-- onchange="verpoliza(2)"-->
                                    <option value="">Seleccione</option>
