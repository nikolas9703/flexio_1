...
<template id="detalle_template">
    ...
    <div class="row">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3 ">
            ...
            <select name="campo[cliente_id]" id="select_cliente" data-rule-required="true" aria-required="true" v-model="detalle.cliente_id" v-select2="detalle.cliente_id" :config="config.select2" :disabled="config.disableDetalle || empezable.type != ''">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3 ">
            ...
            <select name="campo[item_precio_id]" class="" id="item_precio_id" data-rule-required="true" aria-required="true" v-model="detalle.item_precio_id" v-select2="detalle.item_precio_id" :config="config.select2" :disabled="config.disableDetalle">
                <option value="">Seleccione</option>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3 " style="clear: both;">
            ...
            <select name="campo[centro_contable_id]" class="form-control select2" id="centro_contable_id" data-rule-required="true" aria-required="true" v-model="detalle.centro_contable_id" v-select2="detalle.centro_contable_id" :config="config.select2" :disabled="config.disableDetalle">
                <option value="">Seleccione</option>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3 ">
            ...
            <select name="campo[bodega_id]" class="" id="bodega_id" data-rule-required="true" aria-required="true" v-model="detalle.bodega_id" v-select2="detalle.bodega_id" :config="config.select2" ><!--:disabled="config.disableBodega"-->
                <option value="">Seleccione</option>
