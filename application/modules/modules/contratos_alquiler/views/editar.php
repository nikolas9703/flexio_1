                ...
                <!--<div class="row rowhigth">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <span>Empezar contratos desde </span>
                        </div>
                        <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
...
-->
          ...
          echo form_open( $contrato_alquiler->enlace_bitacora , $formdetalle);?>
           <input type="hidden" name="id" value="<?php echo $contrato_alquiler->id?>">
          <?php  echo  form_close();?>
