<div class="row" style="margin-right:0px!important;">
    <div class="ibox-title border-bottom">
        <h5 class="col-xs-12 col-sm-12 col-md-12 col-lg-12">Datos del vehículo</h5>
                        ...
                        <div class="ibox-content m-b-sm" style="display: block; border:0px">
                            ...
                            <div class="row" id="observa">
                                ...
                                <div class="row botones">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                        <input type="submit" name="campo[guardar]" value="Guardar " class="btn btn-primary btn-block guardarVehiculo guardarInteresSolicitud" id="campo[guardar]" />
                                    </div>
                                </div>
