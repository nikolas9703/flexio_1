                            ...
                            <div class="ibox border-bottom">
                                ...
                                <div class="ibox-content" style="display:none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                            <label for="">No. de Caso</label>
                                            <input type="text" id="no_caso" class="form-control" value="" placeholder="">
                                        </div>
                                        <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                            <label for="">No. de Certificado</label>
                                            <input type="text" id="no_certificado" class="form-control" value="" placeholder="">
                                        </div>
                                        <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
...
<?php echo form_close(); ?>
                            ...
                            <!-- JQGRID -->
<?php echo modules::run('reclamos/ocultotabla'); ?>
                            <!-- /JQGRID -->
                        </div>
                    </div>
                </div>
...
<div id="menu_crear" style="display:none;">
 ...
 ?>
 <?php 
        if($row['padre_id'] == 0 && $row['estado'] == 1 && $row['level'] == 1 && $cont >= 1){ ?>
 ...
 <?php          }elseif($result['padre_id'] == $info['id'] && $result['estado'] == 1 && $result['level'] == 3 && !empty($result['codigo_ramo'])){ ?>
                     <li class="m-sm">
...
<?php           }elseif($info['padre_id'] == $id_solicitudes && $info['estado'] == 1 && $cont2 == 0 && in_array($info['id'],$rolesArray) && in_array($info['id'],$usuariosArray) ){ ?>
                    <li class="m-md">     
...
<?php
$formAttr = array('method' => 'POST', 'id' => 'exportarReclamos', 'autocomplete' => 'off');
echo form_open(base_url('reclamos/exportar'), $formAttr);
?>
...
echo '<input type="text" value="" name="poliza_id" />';
echo form_close();
...
echo Modal::config(array(
    "id" => "opcionesModalAnulado",
    "size" => "md"
))->html();
echo Modal::config(array(
    "id" => "opcionesModalCerrado",
    "size" => "md"
))->html();
/*echo Modal::config(array(
    "id" => "documentosModal",
