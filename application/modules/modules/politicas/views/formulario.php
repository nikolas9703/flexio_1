                   ...
                   <select multiple name="categorias[]" class="form-control select2" id="categoria_id" data-rule-required="true" v-select="formulario.categorias" v-model="formulario.categorias"  data-placeholder="Seleccione">
                      ...
                      <option v-for="categoria in catalogos.categorias" v-bind:value="categoria.id">
                       {{categoria.nombre}}
                                               ...
                                               <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3" v-if="formulario.modulo !=='pedido' && formulario.modulo !=='aseguradora' && formulario.modulo !=='cobros' && formulario.modulo !=='ramos' && formulario.modulo !=='ajustadores' && formulario.modulo !=='agentes' && formulario.modulo !=='intereses_asegurados' && formulario.modulo !=='solicitudes' && formulario.modulo !=='polizas'">
