    	...
    	<div class="col-lg-12">
            ...
            echo form_open(base_url('notas_creditos/guardar'), $formAttr);?>
              ...
              <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 header-ventas">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <select  class="form-control" name="campo[tipo]" id="tipo" v-model="cabecera.tipo" @change="seleccionarAplicar()">
                  <option value="">Seleccione</option>
                  <option value="factura">Factura</option>
                </select>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <select  class="form-control" name="tipoId" id="tipoId" v-model="cabecera.tipoId" @change="llenarFormulario(cabecera.tipoId)" :disabled="disabledOpcionTipo">
