...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><span class="Estilo5">&nbsp;Vacaciones  </span></td>
        <td><span class="Estilo5">$&nbsp;<?php echo isset($salario_bruto)?number_format($salario_bruto,2):''?> </span> </td>
        </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="25%" class="linea2"><span class="Estilo5">Pagado al a&ntilde;o</span></td>
         ...
         <?php 
         $sumatoria_deducciones = $sumatoria_ingresos = $sumatoria_descuentos = 0;
