...
<div id="container">
  ...
  <div id="right"></div>
  <div id="center">Comprobante de Pago/<?php echo $tipo_planilla;?></div>
</div>
<br><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="50%"  valign="top" class="linea4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="32%" class="linea2"><span class="Estilo5">Ingresos </span></td>
    <td width="18%" class="linea2"><span class="Estilo5">Horas</span></td>
    <td width="16%" class="linea2"><span class="Estilo5">Rata</span></td>
    <td width="14%" class="linea2"><span class="Estilo5">Importe</span></td>
    </tr>
  <?php 
  ...
  foreach ($lista_ingresos as $ingreso)	{ 
	$ingreso_individual =  isset($ingreso['calculo'])?$ingreso['calculo']:'0'; 
?>
  <tr>
    <td><span class="Estilo5"><?php echo isset($ingreso['detalle'])?$ingreso['detalle']:''?> </span></td>
    <td><span class="Estilo5"><?php echo isset($ingreso['cantidad_horas'])?$ingreso['cantidad_horas']:''?> </span></td>
    <td><span class="Estilo5">$&nbsp;<?php echo isset($ingreso['rata'])?number_format($ingreso['rata'],2):''?> </span></td>
    <td><span class="Estilo5">$&nbsp;<?php echo number_format($ingreso_individual,2);?> </span></td>
    </tr>
  <?php 
  $sumatoria_ingresos += $ingreso_individual;
} } ?>
...
?>
	 ...
	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%" class="linea2"><span class="Estilo5">&nbsp;Acumulados </span></td>
        <td width="25%" class="linea2"><span class="Estilo5">Anual</span></td>
        <td width="25%" class="linea2"><span class="Estilo5">Total</span></td>
        </tr>
         <?php if(!empty($lista_acumulados))
  {
  foreach ($lista_acumulados as $acumulado)	{ ?>
      <tr>
        <td><span class="Estilo5">&nbsp;<?php echo isset($deduccion['nombre'])?$acumulado['nombre']:''?>  </span></td>
        <td><span class="Estilo5">$&nbsp;<?php echo isset($deduccion['descuento'])?number_format($acumulado['acumulado'],2):''?> </span> </td>
        <td><span class="Estilo5">$&nbsp;<?php echo isset($deduccion['saldo'])?number_format($acumulado['saldo'],2):''?>  </span></td>
        </tr>
        <?php } } ?>
    </table>
	</td>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="12%" class="linea2"><span class="Estilo5">Rata por hora</span></td>
    <td width="18%" class="linea2"><span class="Estilo5">$&nbsp;<?php echo number_format($rata,2); ?></span></td>
    <td width="11%" class="linea2"><span class="Estilo5">Ingresos:</span></td>
    <td width="20%" class="linea2"><span class="Estilo5">$&nbsp;<?php echo number_format($sumatoria_ingresos,2); ?></span></td>
    <td width="14%" class="linea2"><span class="Estilo5">Deducciones:</span></td>
    <td width="11%" class="linea2"><span class="Estilo5">$&nbsp;<?php echo number_format($sumatoria_descuentos+ $sumatoria_deducciones,2); ?></span></td>
    <td width="14%" class="linea2">&nbsp;</td>
   </tr>
  <tr>
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2"><span class="Estilo7" >Pago Neto: $ <?php echo number_format($sumatoria_ingresos - ($sumatoria_descuentos+ $sumatoria_deducciones),2); ?></span></td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
   </tr>
