...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="14%" class="linea2"><span class="Estilo5">Acumulado</span></td>
    </tr>
  <?php 
  $sumatoria_descuentos = $sumatoria_deducciones = $sumatoria_ingresos = $salario = 0;
 
   if(!empty($lista_ingresos)){
  	foreach ($lista_ingresos  AS  $row){
 
	$salario = isset($row['salario_bruto'])?$row['salario_bruto']*0.08333:'0'; 
	 
  ?>
  <tr>
    <td><span class="Estilo5"><?php echo  $row['fecha_final'];  ?> </span></td>
    <td><span class="Estilo5">- </span></td>
    <td><span class="Estilo5">-</td>
    <td><span class="Estilo5">$&nbsp;<?php  echo $row['salario_bruto']; ?> </span></td>
    <td>&nbsp;</td>
    </tr>
  <?php 
   $sumatoria_ingresos += $salario;
	} 
} 
...
?>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="13%" class="linea2"><span class="Estilo5">Rata por hora</span></td>
    <td width="18%" class="linea2"><span class="Estilo5">$&nbsp;<?php echo number_format($rata,2); ?></span></td>
    <td width="18%" class="linea2"><span class="Estilo5">Ingresos:</span></td>
    <td width="12%" class="linea2"><span class="Estilo5">$&nbsp;<?php echo number_format($sumatoria_ingresos,2); ?></span></td>
  ...
  <tr>
    ...
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2" ><span class="Estilo7">Pago Neto: </span></td>
    <td class="linea2"><span>$&nbsp;<?php echo number_format($sumatoria_ingresos - ($sumatoria_descuentos+ $sumatoria_deducciones),2); ?></span></td>
    <td class="linea2">&nbsp;</td>
    <td class="linea2">&nbsp;</td>
   </tr>
</table>
