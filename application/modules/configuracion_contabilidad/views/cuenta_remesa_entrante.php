<div class="row">
  <div class="alert alert-dismissable alert-info">
      ...
      <p><strong>Seleccione</strong> una sola cuenta para Remesas Entrantes.</p>
  </div>
  <table id="remesa_entrante" class="table table-striped"><!-- tree-table cuentas_config -->
    ...
    <tbody>
      <tr>
        <td>
          <div id="remesas_entrantes" >cuentas</div><!-- class="cuentas" -->
        </td>
  ...
  <div class="row">
    ...
    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6"><button id="btnGuardarRemesaEntrante" class="btn btn-block btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label">Guardar</span></button></div>
  </div>
</div>
