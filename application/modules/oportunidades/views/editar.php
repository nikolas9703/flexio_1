                ...
                <div class="row" style="margin-right: 0px;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color: #D9D9D9;padding: 7px 0 7px 0px;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <select class="form-control" name="campo[empezar_desde_type]" required="" data-rule-required="true" v-select2="oportunidad.empezar_desde_type" :disabled="disabledEditar || config.vista == 'editar'">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <select  class="form-control" name="campo[empezar_desde_id]" v-select2="oportunidad.empezar_desde_id" :disabled="config.vista == 'editar' || oportunidad.empezar_desde_type == '' || disabledHeader || disabledEditar">
                                <option value="">Seleccione</option>
