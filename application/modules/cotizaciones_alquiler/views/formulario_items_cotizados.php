...
<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
    ...
    <textarea name="campo[observaciones]" class="form-control" v-model="cotizacion_alquiler.observaciones" :disabled="disabledEditar"></textarea>
</div>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 last-div">
    ...
    <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
        <input type="hidden" name="campo[id]" id="cotizacion_alquiler_id" value="{{cotizacion_alquiler.id}}" />
