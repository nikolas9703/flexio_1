                                                                ...
                                                                <?php
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <input ng-model="ramos.descripcion" type="text" id="descripcion" name="descripcion" class="form-control" value="" placeholder="" autocomplete="off" >
                                                                        </div>
                                                                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <select ng-model="ramos.tipo_interes_ramo" name="tipo_interes_ramo" id="tipo_interes_ramo" class="form-control chosen-select" >
                                                                                <option value=""></option>
                                                                        ...
                                                                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <select ng-model="ramos.tipo_poliza_ramo" name="tipo_poliza_ramo" id="tipo_poliza_ramo"  class="form-control chosen-select"  >
                                                                                <option value=""></option>
                                                                                ...
                                                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="form-group col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                                                                            ...
                                                                                            <input type="text" id="nombre_plan"  name="nombre_plan" class="form-control" v-model="nombre_plan" placeholder="" data-rule-required="true">
                                                                                        </div>
                                                                                        <div class="form-group col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
