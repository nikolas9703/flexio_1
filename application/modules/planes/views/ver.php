             ...
             <div class="tab-content">
              ...
              <div id="tab-3" class="tab-pane <?php echo $actplanes; ?>">
                <div class="panel-body" >
                 <div style="font-size: 2em; margin-left: -25px;">&nbsp; Detalles plan de seguro</div>
                 ...
                 <div role="tabpanel">
                     ...
                     <div class="col-lg-12">
                      <div class="">
                       <!--<ul class="nav nav-tabs nuevo tabplanes" style="border-bottom: none">
                        <li id="tab_aseguradora" style="margin-right: 30px; margin-left: -25px;background-color:#F3F3F4 !important;">
                  ...
                  <li class="active" id="tab_confirmar" style="margin-right: 30px;background-color:#F3F3F4 !important;">
              ...
              <div class="tab-content row" ng-controller="configPlanesController">
                ...
                <div class="tab-content">
                 <div id="tab2-1" class="tab-pane" style="margin-top: -60px; margin-left: -40px">
                  <div class="panel-body">

                   <div style="background: #fff;">
                    <div class="row">
                     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <input id="id_planes" name="id_planes" value="<?php echo $planes['id']; ?>" v-model="id_planes" type="hidden">
...
<div id="tab2-4" class="tab-pane active" style="margin-top: -60px; margin-left: -40px">
  <div class="panel-body">
...
<input id="uuid_aseguradora" value="<?php echo $uuid['uuid_a']; ?>" type="hidden">
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <div class="form-group col-xs-12 col-sm-4 col-md-2 col-lg-2">
  <button type="button" id="volver" class="btn btn-primary btn-block" style="width: 100px;"> Confirmar</button>
