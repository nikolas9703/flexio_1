      ...
      <?php $actramos=""; $actplanes="active"; ?>
          ...
          <div class="row">
            <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" style="">
              ...
              <select ng-model="ramos.rol" data-placeholder="Seleccione una opción" multiple="true" name="rol" id="rol" class="form-control chosen-select grouper">
           ...
           <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
            ...
            <select ng-model="ramos.usuario" multiple="true"  data-placeholder="Seleccione una opción" name="usuario" id="usuario"  class="form-control chosen-select  grouper">
