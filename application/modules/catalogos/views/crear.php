														...
														<div class="ibox-content tab-pane fade in active" id="Impuesto">
															...
															<div class="row">
																<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
																	...
																	<input ng-model="ramos.descripcion" type="text" id="descripcion" name="descripcion" class="form-control" value="" placeholder="" autocomplete="off" data-rule-required="true">
																</div>
																<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
																	<label for="">Código<span required="" aria-required="true">*</span></label>
																	<input ng-model="ramos.codigo_ramo" value="" maxlength="3" type="text" id="codigo_ramo" name="codigo_ramo" class="form-control" placeholder="" autocomplete="off" data-rule-required="true" pattern=".{1,3}">
																</div>
															</div>
															<div class="row">
																<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
																	<label for="">Tipo de interes asegurado <span required="" aria-required="true">*</span></span></label>
																	<select ng-model="ramos.tipo_interes_ramo" name="tipo_interes_ramo" id="tipo_interes_ramo" class="form-control chosen-select" data-rule-required="true">
																		<option value=""></option>
																...
																<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
																	...
																	<select ng-model="ramos.tipo_poliza_ramo" name="tipo_poliza_ramo" id="tipo_poliza_ramo"  class="form-control chosen-select"  data-rule-required="true">
																		<option value=""></option>
																								...
																								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
																									...
																									<div class="row">
																										...
																										<div class="form-group col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
																											...
																											<select name="impuesto" id="impuesto" class="form-control" v-model="impuesto" data-rule-required="true">
																												<option value=""></option>
																										...
																										<table  id="tabla_fact" style="width: 100%;">
																											<thead>
																												<tr >
																													<th style="width: 95%;">
																														...
																														<label for="nPwombre_plan">Coberturas(s)</label>
																														</div>
																													</th>
																													<th style="width: 5%;"></th>
																												</tr>
																											...
																											<tbody>
																												...
																												<tr>
																													...
																													<td>
																														<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 0px !important;padding-left: 0px;" >
																															<input  type="text" id="nombre_plan"  name="coberturasmonet[]" class="form-control" value="" placeholder=""  >
																														</div>
																													</td>
