       ...
       <div class="row tab-content">
         ...
         <div class="row">
          <div class="col-lg-12">
           <div class="">
            ...
            <?php if($ramosPermission['listar']&&$ramosPermission['editar']) {?>
                ...
                <div class="row">
                 <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <p></p>
                   ...
                   <h4> <input type="checkbox" name="" id="isGrouper"> Agrupador</h4>  
                </div>
                <div>
        ...
        <div class="row">
          <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" style="">
            ...
            <select ng-model="ramos.rol" data-placeholder="Seleccione una opción" multiple="true" name="roles[]" id="rol" class="form-control chosen-select grouper">
         ...
         <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
          ...
          <select ng-model="ramos.usuario" multiple="true"  data-placeholder="Seleccione una opción" name="usuarios[]" id="usuario"  class="form-control chosen-select  grouper">
...
<td>
 <div class="form-group col-xs-11 col-sm-11 col-md-11 col-lg-11" style="margin-bottom: 0px !important;padding-left: 0px;" >
  <div class="input-group">
   <input  type="text" id="nombre_plan" required data-area-required="true" name="p_comision[0]" onkeyup="planes.copyTabla('tabla_comis','tabla_final_comisiones');" class="form-control coberturas" value="<?=$comision->comision ?>" placeholder="" >
   <span class="input-group-addon">%</span>
 </div>
</div>
</td>
