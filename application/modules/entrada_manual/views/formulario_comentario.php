...
<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 Comentario<spanrequired>*</span>">
  <form id="entradaComentarioForm">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="form-group col-xs-2 col-sm-2 col-md-2 col-lg-2"><button type="button" ng-click="guardarComentario(comentarios,$target)" class="btn btn-block btn-primary">Guardar</button></div>
    </div>
  </form>
</div>
<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
      <div class="ibox-content" ng-hide="historial == ''">
        <div class="vertical-container dark-timeline center-orientation"  infinite-scroll-distance='3'>
           <div class="vertical-timeline-block" ng-repeat="item in historial">
