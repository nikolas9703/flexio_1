...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <label for="proveedor">Cliente <span required="" aria-required="true">*</span></label>
        <select data-placeholder="Seleccione" name="campo[cliente]" class="form-control chosen-select" id="cliente" data-rule-required="true" ng-change="clienteChange(datosAbono.clienteActual)" ng-model="datosAbono.clienteActual" ng-disabled="disableSelected !==''">
    ...
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
        ...
        <div class="input-group">
            <span class="input-group-addon">$</span>
            <input type="input-left-addon" disabled ng-model="datosAbono.credito_favor" name="campo[lcredito]" value="" class="form-control debito" id="campo[lcredito]">
        </div>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <label>Abonar a Cuenta de Banco <span required="" aria-required="true">*</span></label>
    </div>
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 item-listing lists_opciones" id="opciones{{$index}}"  ng-repeat="abono in opcionAbonos track by $index">
    <div class="lists_opciones" id="opcionesRow{{$index}}">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" style="display: show;">
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" style="display: show;">
                        <button type="button" class="btn btn-default btn-block" data-rule-required="true" agrupador="items" aria-required="true" ng-click="$index === 0 ?'':ngClick.deleteRow(abono)" ng-disabled="disabled"><i class="fa fa-trash"></i></button>
    ...
    <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding" ng-show="abono.tipo_abono ==='ach'" ng-class="abonoClass($index)">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <select name="metodo_abono[{{$index}}][nombre_banco_ach]" ng-model="abonoBanco.banco" id="nombre_banco_ach{{$index}}" class="form-control" >
                <option value=""></option>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 last-input">
            <input type="text" ng-model="abonoBanco.cuenta" name="metodo_abono[{{$index}}][cuenta_cliente]" id="cuenta_proveedor{{$index}}" class="form-control" />
        </div>
    </div>
    ...
    <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding" ng-show="abono.tipo_abono ==='cheque'" ng-class="abonoClass($index)">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <input type="text" ng-model="abonoCheque.numero" name="metodo_abono[{{$index}}][numero_cheque]" id="numero_cheque{{$index}}" class="form-control"/>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <label>Nombre Banco</label>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 last-input">
            <input type="text" ng-model="abonoCheque.nombre" name="metodo_abono[{{$index}}][nombre_banco_cheque]" id="nombre_banco_cheque{{$index}}" class="form-control" />
        </div>
    </div>
  ...
  <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 no-left-padding" ng-show="abono.tipo_abono ==='tarjeta_de_credito'" ng-class="abonoClass($index)">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <input type="text" ng-model="abonoTarjeta.numero" name="metodo_abono[{{$index}}][numero_tarjeta]" id="numero_tarjeta{{$index}}" class="form-control" />
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <label>Número de recibo</label>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 last-input">
      <input type="text" ng-model="abonoTarjeta.recibo" name="metodo_abono[{{$index}}][numero_recibo]" id="numero_recibo{{$index}}" class="form-control" />
    </div>
  </div>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 last-div">
    ...
    <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
      <a href="javascript:history.back(1)" class="btn btn-default btn-block" id="cancelarFormBtn">Cancelar </a>
    </div>
    <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
