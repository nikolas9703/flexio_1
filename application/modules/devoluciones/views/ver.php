    	...
    	<div class="col-lg-12">
            ...
            echo form_open(base_url('devoluciones/guardar'), $formAttr);?>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 header-ventas" v-show="acceso">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <select  class="form-control" name="tipo" id="tipo" v-model="devolucionHeader.tipo" v-on:change="empezarDesde(devolucionHeader.tipo)" :disabled="headerDisabled">
              ...
              <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <select  class="form-control" name="uuid_tipo"  v-model="devolucionHeader.uuid" v-on:change="llenarFormulario(devolucionHeader.uuid)" :disabled="headerDisabled">
                  <option value="">Seleccione</option>
