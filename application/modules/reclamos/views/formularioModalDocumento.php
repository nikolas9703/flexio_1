<?php echo form_open_multipart(base_url('reclamos/ajax_guardar_documentos'), "id='guardarDocumento'"); ?>
<input type="hidden" name="id_reclamo" id="id_reclamo_documento" value="" />
