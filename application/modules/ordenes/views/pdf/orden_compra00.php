...
<div id="container">
  <table style="width: 100%;">
        <!--seccion de cabecera-->
        <tr>
            <td rowspan="3"> <img id="logo" src="<?php $logo = !empty($orden_compra->empresa->logo)?$orden_compra->empresa->logo:'default.jpg'; echo $this->config->item('logo_path').$logo;?>" alt="Logo" border="0" height="85px" width="85px" /></td>
                    ...
                    <tbody>
                        ...
                        <tr class="titulo5">
                          <td><?php $num_pedido = !isset($orden_compra->pedido->numero)?'':'PD'.$orden_compra->pedido->numero; echo $num_pedido?></td>
                            ...
                            <td><?php echo $item->atributos[0]->nombre?></td>
    ...
    <tr>
		...
		?>
        <td width="28%" rowspan="4"> <img id="logo1" src="<?php echo $this->config->item('qr_path').$nombre_qr;?>" alt="Logo2" border="0" height="100px" width="100px" /></td>
        ...
        <tr>
        <td>o valla a la direcci&oacute;n</td>
