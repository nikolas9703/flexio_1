                        ...
                        <div class="ibox-content m-b-sm" style="display: block; border:0px">
                            <div class="row">
                                ...
                                <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>Asignado al acreedor %
                                    ...
                                    <div class="input-group">  
                                        <input type="text" name="campo[asignado_acreedor]" id="asignado_acreedor" class="form-control" <?php if (isset($campos['datos']['asignado_acreedor'])) { ?> value="<?php echo $campos['datos']['asignado_acreedor'] ?>"  <?php } ?>><span class="input-group-addon">%</span></div>
                                </div>
                                <!--                                <div class="form-group col-xs-12 col-sm-2 col-md-1 col-lg-1"><label style="color: transparent">a</label>
                                                                    <input type="text" class="form-control" name="campo[tipo_propuesta_opcional]" id="tipo_propuesta"/>
                                                                </div>-->
                                ...
                                <div class="form-group col-xs-12 col-sm-2 col-md-1 col-lg-1"><label style="color: transparent">a</label>
                                    <input type="text" class="form-control" name="campo[acreedor_opcional]" id="acreedor_opcional"/>
                                </div>
                                <div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-2"><label>Validez de la fianza</label>
                                    <select class="form-control validez_fianza_pr" name="campo[validez_fianza_pr]"> 
                                         <option value="">Seleccione</option>
                                        <?php foreach ($validez_fianza as $fianza) { ?>
                                            ...
                                            if (isset($campos['datos']['validez_fianza_pr'])) {
                                                if ($campos['datos']['validez_fianza_pr']==$fianza->id_cat) {
                                                    echo ' selected';
                                                } else if ($campos['datos']['validez_fianza_pr'] == "otro") {
                                                    echo ' selected';
                                                }
                                            }
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-6 "><label>Observaciones</label>
                                    <textarea name="campo[observaciones]"
                                              class="form-control" id="observaciones_proyecto" ><?php if (isset($campos['datos']['observaciones'])) {
                                ...
                                <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" >
                                    ...
                                    <select class="form-control estado_proyecto" name="campo[estado]">
                                        <?php foreach ($estado as $status) { ?>
                                            <option <?php
                                            if (isset($campos['datos']['estado'])) {
                                                if ($status->etiqueta == $campos['datos']['estado']) {
                                                    echo ' selected';
                                                }
                                            }
                                            ?> value="<?php echo $status->etiqueta ?>"><?php echo $status->etiqueta ?></option>
<?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="row botones">
                                ...
                                <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                    <input type="submit" name="campo[guardar]" value="Guardar "
                                           class="btn btn-primary btn-block guardarProyecto" id="campo[guardar]">
                                </div>
                            </div>
                        </div>
                    </div>
