                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                    ...
                                    <select class="form-control acreedor_carga" name="campo[acreedor]" >
                                        ...
                                        <?php }  ?>
                                        <option value="otro" <?php if(isset($campos['datos']['acreedor'])){ if($campos['datos']['acreedor']=="otro" ) {echo ' selected';}} ?>>Otro</option>
                                    </select>
                                </div>
                                <div class="form-group col-xs-12 col-sm-2 col-md-1 col-lg-1"><label></label>
                                    <input type="text" class="form-control" value="<?php if(isset($campos['datos']['acreedor'])){ if($campos['datos']['acreedor']=="otro" ) {echo $campos['datos']['acreedor_opcional'];}} ?>" name="campo[acreedor_opcional]" id="acreedor_carga_opcional" <?php if(isset($campos['datos']['acreedor'])){ if($campos['datos']['acreedor'] != "otro" ) {echo ' disabled';}} ?>/>
                                </div>
                                <div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                    ...
                                    <select class="form-control tipo_obligacion" name="campo[tipo_obligacion]" >
                                        ...
                                        <?php }  ?>
                                        <option value="otro" <?php if(isset($campos['datos']['tipo_obligacion'])){ if($campos['datos']['tipo_obligacion'] == "otro" ) {echo ' selected';}} ?> >Otro</option>
                                    </select>
                                </div>
                                <div class="form-group col-xs-12 col-sm-2 col-md-1 col-lg-1"><label></label>
                                    <input type="text" class="form-control" value="<?php if(isset($campos['datos']['tipo_obligacion'])){ if($campos['datos']['tipo_obligacion'] == "otro" ) {echo $campos['datos']['tipo_obligacion_opcional'];}} ?>" name="campo[tipo_obligacion_opcional]" id="tipo_obligacion_opcional"  <?php if(isset($campos['datos']['tipo_obligacion'])){ if($campos['datos']['tipo_obligacion'] != "otro" ) {echo ' disabled';}} ?> />
                                </div>
                            </div>
