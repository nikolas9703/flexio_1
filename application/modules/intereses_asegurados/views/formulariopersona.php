		...
		<div id="vistaPersona">
			<div class="tab-content">
				<div id="datosdelPersona-5" class="tab-pane active">
					...
					<input type="hidden" name="campo[idPersona]" value="<?php if(isset($campos['id'])){
						print $campos['id'];
					} ?>" id="idPersona">
					...
					<div class="ibox">
						<div class="ibox-content m-b-sm" style="display: block; border:0px">
							<div class="row">
								...
								<?php if (isset($campos["datos"]["identificacion"]) ):
								...
								<div class="col-xs-12 col-sm-3 col-md-2 col-lg-2" >
									...
									<select data-rule-required="true" class="form-control identificacion" name="campo[identificacion]" id="identificacion">
										...
										<option <?php if (isset($indentity)) if(similar_text($tipo_iden->etiqueta , $indentity)>=6)
											echo 'selected ';?> 
								...
								<div>
									<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 noPAS" >
										...
										<select data-rule-required="true" class="form-control provincia" name="campo[provincia]" id="provincia">
											<option value="">Seleccione</option>
											<?php 
											$sum=1;
											foreach ($info['provincias'] as  $provincia) {  ?>
											<option <?php  if(isset($provinciaVal)) if($sum== $provinciaVal) 
											{echo ' selected';}  ?> value="<?php echo $sum; ?>"><?php echo $provincia->etiqueta ?></option>
											<?php $sum++; }  ?>
										</select>
									...
									<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 noPAS">
										...
										<select data-rule-required="true" class="form-control letra" name="campo[letra]" id="letra">
											...
											<option <?php if(isset($letraVal)){ if($letra->etiqueta == $letraVal) {echo ' selected';} } ?> value="<?php echo $letra->etiqueta ?>"><?php echo $letra->etiqueta ?></option>
											<?php }  ?>
										</select>
										<input type="hidden" name="id_letras" id="id_letras" value="">
									</div>                            
									<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 noPAS">
										<label>Tomo <span required="" aria-required="true">*</span></label>
										<input data-rule-required="true" value="<?php if(isset($tomo)){ echo $tomo; } ?>" type="text" id="tomo" name="campo[tomo]" class="form-control tomo">
									</div>
									<div class="  col-xs-6 col-sm-3 col-md-2 col-lg-2 noPAS">
										<label>Asiento <span required="" aria-required="true">*</span></label>
										<input data-rule-required="true" value="<?php if(isset($asiento)){ echo $asiento; } ?>" type="text" id="asiento" name="campo[asiento]" class="form-control asiento">
									</div>
								</div>
								<div class="PAS">
									<div class="  col-xs-12 col-sm-12 col-md-3 col-lg-3">
										<label>No. Pasaporte <span required="" aria-required="true">*</span></label>
										<input data-rule-required="true" value="<?php if(isset($pasaporte)){ echo $pasaporte; } ?>" type="text"  id="pasaporte" name="campo[pasaporte]" class="form-control pasaporte">
									</div>
								</div>
							...
							<div class="row">
								<div class="  col-xs-6 col-sm-2 col-md-2 col-lg-2 ">
									...
									<div class="input-group">
										...
										value="<?php if (!empty($campos["datos"]->fecha_nacimiento)) {
									...
									<div class="form-group col-xs-6 col-sm-1 col-md-1 col-lg-1 " >
										...
										value="<?php if (!empty($campos["datos"]->edad)) {
									...
									<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" >
										...
										<select data-rule-required="true" class="form-control estado_civil" name="campo[estado_civil]" id="estado_civil">
											...
											<option <?php if(!empty($campos["datos"]->estado_civil)){ if($row->id_cat == $campos["datos"]->estado_civil ) {echo ' selected';}} ?> value="<?php echo $row->id_cat ?>"><?php echo $row->etiqueta ?></option>
											<?php }  ?>
										</select>
									</div>
									<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3 nombreAjustadores"><label>Nacionalidad</label>
										<input type="text" name="campo[nacionalidad]" id="nacionalidad" value="<?php if (!empty($campos["datos"]->nacionalidad)) {
									...
									<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" >
										...
										<select data-rule-required="true" class="form-control sexo" name="campo[sexo]" id="sexo">
											...
											<option <?php if(!empty($campos["datos"]->sexo)){ if($se->id_cat == $campos["datos"]->sexo ) {echo  'selected';}} ?> value="<?php echo $se->id_cat?>"><?php echo $se->etiqueta ?></option>
											<?php }  ?>
										</select>
									</div>
									<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3"><label>Estatura(mt)</label>
										<input type="text" name="campo[estatura]" id="estatura" value="<?php if (!empty($campos["datos"]->estatura)) {
									...
									<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3 nombreAjustadores"><label>Peso(lb)</label>
										<input type="text" name="campo[peso]" id="peso" value="<?php if (!empty($campos["datos"]->peso)) {
									...
									<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3 ">
										...
										<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3 ">
											...
											<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-6 "><label>Direcci&oacute;n residencial</label>
												...
												value="<?php if (!empty($campos["datos"]->direccion_residencial)) {
											...
											<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-6 "><label>Direcci&oacute;n laboral</label>
												...
												value="<?php if (!empty($campos["datos"]->direccion_laboral)) {
											...
											<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-4 ">
												...
												<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-4 "><label>Observaciones</label>
													<textarea name="campo[observaciones]"
													value="" class="form-control" id="observacionesPersona"><?php if (!empty($campos["datos"]->observaciones)): echo $campos["datos"]->observaciones; endif;?></textarea>
									...
									<div class="row detalleinteres_persona" style="display:none">
										...
										<div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-1 salud">
											...
											<select name="campodetalle[beneficio_vida]" id="beneficiodetalle_persona" class="form-control">
												<option value="">Seleccione</option>
