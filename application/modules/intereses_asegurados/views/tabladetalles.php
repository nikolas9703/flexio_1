          ...
          <div class="col-lg-12">
            <div class="">
				<ul class="nav nav-tabs">
					...
					<li id="tab_intereses"><a data-toggle="tab" href="#tab-2" aria-expanded="true" data-targe="generales">Pólizas</a></li>
							...
							<div class="panel-body" style="padding: 0px 15px 0px 0px!important">
								<div class="tab-content row" >
									...
									<div class="ibox-content tab-pane fade in active" id="accionPersonalTabla2">
										<div><?php echo modules::run('intereses_asegurados/ocultotablapolizas',$campos["uuid"]);  ?></div>
									</div>
								</div>
							</div>
						</div>
