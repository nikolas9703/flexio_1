            ...
            try {
                ...
                if (empty($campo['uuid'])) {
                    ...
                    if ($verificar_proyecto == 0) {
                        ...
                        $comentario = "<b>Interés Proyecto</b><br><br>";
                    ...
                    if ($this->auth->has_permission('acceso', 'intereses_asegurados/editar/(:any)')) {
                       ...
                       /* if ($tipo_fianza == "propuesta") {
                        ...
                        if ($verificar_proyecto == 0) {
                            ...
                            if (isset($campo['representante_legal'])) {
                            ...
                            if (isset($campo['tipo_fianza'])) {
                                if ($proyectoObj->tipo_fianza != $campo['tipo_fianza']) {
                                    //var_dump($campo['tipo_fianza']);
                                    //$fianza_nueva=Catalogos::find($campo['tipo_fianza'])->etiqueta;
                                    $comentario .= "<b>Campo: Tipo de Fianza</b><br>Valor Actual:" . $campo['tipo_fianza'] . "<br>Valor Anterior:" . $proyecto_actividad->tipodeFianza->etiqueta . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
                            if (isset($campo['monto'])) {
                            ...
                            if (isset($campo['monto_afianzado'])) {
                            ...
                            if (isset($campo['validez_fianza_opcional'])) {
                            ...
                            if (isset($campo2['estado'])) {
                                ...
                                $estado = $campo2['estado'];
                            } else {
                                $estado = '';
                            }

                            $intereses_asegurados->estado = $estado;
            ...
            try {
                if (empty($campo['uuid'])) {
                    ...
                    if ($verificar_ubicacion == 0) {
                        ...
                        if ($ubicacion->direccion_ubicacion != '')
                            $comentario .= "<b>Campo: Dirección de la ubicación</b><br>Valor: " . $ubicacion->direccion_ubicacion . "<br><br>";
                        if ($ubicacion->edif_mejoras != '')
                            $comentario .= "<b>Campo: Edificio y mejoras</b><br>Valor: " . $ubicacion->edif_mejoras . "<br><br>";
                        if ($ubicacion->contenido != '')
                            $comentario .= "<b>Campo: Contenido, mercancía, etc</b><br>Valor: " . $ubicacion->contenido . "<br><br>";
                        if ($ubicacion->maquinaria != '')
                            $comentario .= "<b>Campo: Maquinaria y equipos</b><br>Valor: " . $ubicacion->maquinaria . "<br><br>";
                        if ($ubicacion->inventario != '')
                            $comentario .= "<b>Campo: Inventario</b><br>Valor: " . $ubicacion->inventario . "<br><br>";
                        if ($ubicacion->acreedor != '') {
                        ...
                        if ($ubicacion->observaciones != '')
                            $comentario .= "<b>Campo: Observaciones</b><br>Valor: " . $ubicacion->observaciones . "<br><br>";
                        if ($campo2['estado'] != '')
                            $comentario .= "<b>Campo: Estado</b><br>Valor: " . $campo2['estado'] . "<br><br>";
...
//                }
                    ...
                    if ($this->auth->has_permission('acceso', 'intereses_asegurados/editar/(:any)')) {
                        ...
                        if ($verificar_ubicacion == 0) {
                            ...
                            if (isset($campo['direccion_ubicacion'])) {
                                if ($ubicacionObj->direccion_ubicacion != $campo['direccion_ubicacion']) {
                                    $comentario .= "<b>Campo: Dirección</b><br>Valor Actual:" . $campo['direccion_ubicacion'] . "<br>Valor Anterior:" . $ubicacionObj->direccion_ubicacion . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
                            if (isset($campo['edif_mejoras'])) {
                                if ($ubicacionObj->edif_mejoras != $campo['edif_mejoras']) {
                                    $comentario .= "<b>Campo: Edificio y Mejoras</b><br>Valor Actual:" . $campo['edif_mejoras'] . "<br>Valor Anterior:" . $ubicacionObj->edif_mejoras . "<br><br>";
                                    $cambio = 'si';
                                }
                            }

                            if (isset($campo['contenido'])) {
                                if ($ubicacionObj->contenido != $campo['contenido']) {
                                    $comentario .= "<b>Campo: Contenido, mercancía, etc</b><br>Valor Actual:" . $campo['contenido'] . "<br>Valor Anterior:" . $ubicacionObj->contenido . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
                            if (isset($campo['maquinaria'])) {
                                if ($ubicacionObj->maquinaria != $campo['maquinaria']) {
                                    $comentario .= "<b>Campo: Maquinaria y equipos</b><br>Valor Actual:" . $campo['maquinaria'] . "<br>Valor Anterior:" . $ubicacionObj->maquinaria . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
                            if (isset($campo['inventario'])) {
                                if ($ubicacionObj->inventario != $campo['inventario']) {
                                    $comentario .= "<b>Campo: Inventario</b><br>Valor Actual:" . $campo['inventario'] . "<br>Valor Anterior:" . $ubicacionObj->inventario . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
							if (isset($campo['acreedor'])) {
                            ...
                            if (isset($campo['porcentaje_acreedor'])) {
                                if ($ubicacionObj->porcentaje_acreedor != $campo['porcentaje_acreedor']) {
                                    $comentario .= "<b>Campo: % Acreedor</b><br>Valor Actual:" . $campo['porcentaje_acreedor'] . "<br>Valor Anterior:" . $ubicacionObj->porcentaje_acreedor . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
                            if (isset($campo['observaciones'])) {
                                if ($ubicacionObj->observaciones != $campo['observaciones']) {
                                    $comentario .= "<b>Campo: Observaciones</b><br>Valor Actual:" . $campo['observaciones'] . "<br>Valor Anterior:" . $ubicacionObj->observaciones . "<br><br>";
                                    $cambio = 'si';
                                }
                            }
        ...
        if ($_POST) {
            ...
            if (isset($campodetalle['personaInvidual'])) {
                if ($campodetalle['personaInvidual'] == 1) {
                    $individual = InteresesAsegurados_detalles::where('detalle_relacion', 'Principal')->where('detalle_unico', $_POST['detalleunico'])->select('id_intereses')->count();
                }
            ...
            try {
                if (empty($campo['uuid'])) {
                    ...
                    if ($this->auth->has_permission('acceso', 'intereses_asegurados/editar/(:any)')) {
                        ...
                        $campo['telefono_oficina'] = isset($campo['telefono_oficina']) ? $campo['telefono_oficina'] : '' ;
                        $campo['direccion_laboral'] = isset($campo['direccion_laboral']) ? $campo['direccion_laboral'] : '' ;
                        ...
                        if ($personaObj->telefono_residencial != $campo['telefono_residencial']) {
    ...
    public function ajax_listar_articulo($grid = NULL) {
        ...
        if (!empty($rows->toArray())) {
            foreach ($rows->toArray() AS $i => $row) {
                ...
                $hidden_options .= "<a href='#' class='btn btn-block btn-outline btn-success setIndividualCoverageArt' data-int-gr='" . $row['id_intereses'] . "' data-id='" . $row["id"] . "'>Coberturas</a>";
    ...
    public function ajax_listar_carga($grid = NULL) {
        ...
        if (!empty($rows->toArray())) {
            foreach ($rows->toArray() AS $i => $row) {
                ...
                $hidden_options .= "<a href='#' class='btn btn-block btn-outline btn-success setIndividualCoverageCGA' data-int-gr='" . $row['id_intereses'] . "' data-id='".$row["id"]."'>Coberturas</a>";
