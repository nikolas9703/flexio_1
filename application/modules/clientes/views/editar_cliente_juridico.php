    ...
    <div id="page-wrapper" class="gray-bg row">
    	...
    	<div class="col-lg-12">
        	...
        	<div class="wrapper-content">
	            ...
	            <div class="row editarFormularioClientes">
						...
						<div class="row">
							...
							<div class="form-group col-xs-12 col-sm-10 col-md-10 col-lg-11 tab-pane">
								<div class="progress progress-bar-default" style="margin-bottom:5px;">
									<div class="progress-bar" role="progressbar" aria-valuenow="93" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo !empty($porcentaje_completado) ? $porcentaje_completado : 0; ?>%">
										<span class="sr-only"><?php echo !empty($porcentaje_completado) ? $porcentaje_completado : 0; ?>% Completado</span>
									</div>
								</div>
                ...
                <!-- Subpaneles -->
				<?php Subpanel::visualizar_grupo_subpanel($id_cliente); ?>
