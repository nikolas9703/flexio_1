            ...
            <div class="wrapper-content">
                ...
                <div class="ibox">
                    ...
                    ?>
						...
						<div class="row" id='datos_por_liquidar'>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                    <label>N. Recibo</label>
                                    <select name="no_recibo" id="no_recibo" class="form-control">
                                        <option value="">Seleccione</option>
                                        <?php
                                            foreach ($recibos as $key => $value) {
                                                echo '
                                                <option value="'.$value->id.'">'.$value->codigo.' '.$value->narracion.'</option>
                                                ';
                                            }
                                        ?>
                                    </select>
								...
								<div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
									...
									<input type="text" id="monto_recibo" name="monto_recibo" readonly="readonly" class="form-control" value="" data-rule-required="true" disabled>
								</div>
							</div>
						</div>
                        <div class="row">
                ...
                <?php  echo modules::run('remesas_entrantes/tabla_remesas')?>
				
				 <?php  echo modules::run('remesas_entrantes/tabla_remesas_procesadas')?>
