                ...
                <div role="tabpanel">
                    ...
                    <div class="row tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tabla">
                            ...
                            $formAttr = array(
                                'method' => 'POST',
                                'id' => 'buscarContratosAlquilerForm',
                                'autocomplete' => 'off'
                            );
                            ...
                            <!-- JQGRID -->
                            <?php echo modules::run('contratos_alquiler/ocultotabla'); ?>
...
$formAttr = array('method' => 'POST', 'id' => 'crearFacturaForm','autocomplete'  => 'off');
echo form_open(base_url('facturas/crear'), $formAttr);
echo form_close();
