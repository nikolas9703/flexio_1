  <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12" id="div_comments">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
      <label for="comentario">Comentario</label>
		...
		<input type="hidden" value="<?= $n_solicitud ?>" name="n_solicitud" id="n_solicitud" />
		<textarea rows="5" cols="10" name="campo[comentario]" id="comentario_solicitud" data-rule-required="true"></textarea>
