...
function crear_retiros($retiros_uuid = NULL){
   ...
   if(!empty($_POST["campo"]["incluir"])){$check_narracion = "1";}else{$check_narracion = "0";}
    	...
    	$tipo_pago_id       	= !isset($_POST['campo']['tipo_pago_id']) ? NULL : $_POST['campo']['tipo_pago_id'];
        $numero_cheque = !isset($_POST['campo']['numero_cheque']) ? NULL : $_POST['campo']['numero_cheque'];
        $nombre_banco_cheque = !isset($_POST['campo']['nombre_banco_cheque']) ? NULL : $_POST['campo']['nombre_banco_cheque'];
        $numero_tarjeta = !isset($_POST['campo']['numero_tarjeta']) ? NULL : $_POST['campo']['numero_tarjeta'];
        $numero_recibo = !isset($_POST['campo']['numero_recibo']) ? NULL : $_POST['campo']['numero_recibo'];
        $banco_proveedor = !isset($_POST['campo']['banco_proveedor']) ? NULL : $_POST['campo']['banco_proveedor'];
        $numero_cuenta_proveedor = !isset($_POST['campo']['numero_cuenta_proveedor']) ? NULL : $_POST['campo']['numero_cuenta_proveedor'];  
            ...
            try {
                ...
                $retiros->numero_cuenta_proveedor = $numero_cuenta_proveedor;  
                    if($_POST['campo']['id_categoria'] == "1"){
                        ...
                        $retiros->aseguradora_id        = $id_aseguradora;
                    }
    			...
    			$retiros->save();
                 ...
                 if ($_POST['campo']['id_categoria'] == "1") {
                        ...
                        $id_cliente=NULL;
                        $id_proveedor = NULL;
                        $id_aseguradora = $_POST['campo']['id_categoria'];
                    }    
    			$fieldset = array(
    				"empresa_id" 		=> $this->empresa_id,
    				"narracion"             => $narracion,
    ...
    $this->assets->agregar_var_js(array(
        ...
        if (!empty($retiros_uuid)) {
            ...
            $aseguradora = $retiros->aseguradora;
            ...
            if (!empty($es_cliente)) {
                ...
                $cliente_proveedor = 1;
            } elseif($data_retiros->cliente_id != NULL) {
            ...
            } elseif(!empty($data_retiros->cliente_id)) {

                $cliente_proveedor = $clientes->nombre;
                $id_cliente_proveedor = $data_retiros->cliente_id;
            }else{
                $cliente_proveedor = $aseguradora->nombre;
                $id_cliente_proveedor = $data_retiros->aseguradora_id;
            }
            //----------------------------
            // Agregra variables PHP como variables JS
            //----------------------------
...
public function ocultoformularioretiros($data=NULL)
{
    ...
    private function _createPago($movimiento_monetario_info)
    {
        ...
        if($movimiento_monetario_info->proveedor_id != NULL){
            $proveedor = $movimiento_monetario_info->proveedor_id;
        }elseif($movimiento_monetario_info->cliente_id != NULL){
            $proveedor = $movimiento_monetario_info->cliente_id;
        }else{
            $proveedor = $movimiento_monetario_info->aseguradora_id;
        }
