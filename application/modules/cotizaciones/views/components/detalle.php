...
<template id="detalle_template">
    ...
    <div class="row">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3 ">
            ...
            <select name="campo[cliente_id]" id="select_client" data-rule-required="true" aria-required="true" v-model="detalle.cliente_id" v-select2="detalle.cliente_id" :config="config.select2" :disabled="disabledCliente">
                <option value="">Seleccione</option>
                <option :value="cliente.id" v-for="cliente in getClientes">{{cliente.nombre}}</option>
            </select>
        </div>
        ...
        <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="campo[fecha_desde]" class="form-control"  id="fecha_desde" data-rule-required="true" v-model="detalle.fecha_desde" v-datepicker2="detalle.fecha_desde" :config="config.fecha_desde" disabled>
            </div>
