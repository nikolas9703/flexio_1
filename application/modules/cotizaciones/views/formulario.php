...
<div class="ibox-content" style="display:block;">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="m-b-xs">Items de la Cotización <span required="" aria-required="true">*</span></h4>
    ...
    <div class="row">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
            <a href="<?php echo base_url('cotizaciones/listar'); ?>" class="btn btn-default btn-block" id="cancelarFormBtn">Cancelar </a>
        </div>
        <div class="form-group col-xs-12 col-sm-6 col-md-2 col-lg-2">
            ...
            <input type="hidden" name="campo[oportunidad_id]" value="{{detalle.oportunidad_id}}">
        </div>
    </div>
