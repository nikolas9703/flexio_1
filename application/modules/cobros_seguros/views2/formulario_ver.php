...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
      ...
      <div class="input-group">
          ...
          <input type="text" name="campo[fecha_pago]" class="form-control"  id="fecha_pago" data-rule-required="true" value="" ng-model="datosCobro.fecha_pago" data-rule-required="true" ng-disabled="disabled">
    </div>
    ...
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <label for="cliente_id">Estado </label>
          <select name="campo[estado]" id="estado" ng-model="datosCobro.estado" class="form-control">
            <option value="">Seleccione</option>
...
<<<<<<< HEAD
        <span class="input-group-addon">$</span><input type="text" id="precio_total{{$index}}" name="items[{{$index}}][monto_pagado]" class="form-control precio_total moneda"  ng-model="factura.precio_total" ng-focus="focusPago($index)" ng-blur="cambiarCantidad($index,factura.precio_total)" data-rule-number="true"  placeholder="0.00"/></div>
=======
        <span class="input-group-addon">$</span><input type="text" id="precio_total{{$index}}" name="items[{{$index}}][monto_pagado]" class="form-control precio_total moneda"  ng-model="factura.precio_total"  ng-focus="focusPago($index)" ng-blur="cambiarCantidad($index,factura.precio_total)" data-rule-number="true"  placeholder="0.00"/></div>
>>>>>>> master
    </td>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
    ...
    <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      ...
      <select name="campo[cuenta_id]" ng-model="datosCobro.depositable_id" class="form-control" id="cuenta" data-rule-required="true" ng-disabled="disableCuenta">
        <option value="">Seleccione</option>
  ...
  <div class="lists_opciones" id="opcionesRow{{$index}}">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      ...
      <div class="input-group"><span class="input-group-addon">$</span>
          <input type="text" id="total_pagado{{$index}}" name="metodo_pago[{{$index}}][monto_pagado]" ng-model="pago.total_pagado" class="form-control moneda" style="text-align:right" ng-change="sumaTotales($index)" data-rule-required="true" placeholder="0.00" ng-disabled="disabled"/>
        </div>
        <label id="total_pagado{{$index}}-error" class="error" for="total_pagado{{$index}}"></label>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <button type="button" class="btn btn-default btn-block" agrupador="opciones" ng-click="$index===0? addRow($index): deleteRow($index)" ng-show="false" ><i class="{{pago.icon}}"></i></button>
...
<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 last-div">
  <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-md-offset-9 col-lg-offset-9">
    <div class="input-group"><span class="input-group-addon">$</span>
        <input type="text" id="total_pago" name="campo[total_pagado]" ng-model="datosCobro.total_pago" class="form-control moneda" disabled/>
      </div>
  </div>
  <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-md-offset-9 col-lg-offset-9">
