								...
								<div class="form-group col-xs-6 col-sm-2 col-md-2 col-lg-2 ">
									...
									<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3 ">
										<div class="checkbox m-r-xs" style="padding-left: 20px;position: relative;float: left;margin-top: -10px;height: 5px;">    
											<input type="checkbox" name="campo[telefono_residencial_check]" value="no" class="form-control" id="campo[telefono_residencial_check]">
										...
										<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3 ">
											<div class="checkbox m-r-xs" style="padding-left: 20px;position: relative;float: left;margin-top: -10px;height: 5px;">    
												<input type="checkbox" name="campo[telefono_oficina_check]" value="no" class="form-control" id="campo[telefono_oficina_check]">
											...
											<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-6 "><label>Direcci&oacute;n residencial</label>
												<div class="checkbox m-r-xs" style="padding-left: 20px;position: relative;float: left;margin-top: -10px;height: 5px;">    
													<input type="checkbox" name="campo[direccion_residencial_check]" value="no" class="form-control" id="campo[direccion_residencial_check]">
											...
											<div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-6 "><label>Direcci&oacute;n laboral</label>
												<div class="checkbox m-r-xs" style="padding-left: 20px;position: relative;float: left;margin-top: -10px;height: 5px;">    
													<input type="checkbox" name="campo[direccion_laboral_check]" value="no" class="form-control" id="campo[direccion_laboral_check]">
											...
											<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" >
												...
												<select data-rule-required="true" class="form-control estado" name="campo[estado]">
													...
													<option <?php if(!empty($data->estado)){ if($status->id_cat == $data->estado ) {echo ' selected';}} ?> value="<?php echo $status->id_cat ?>"><?php echo $status->etiqueta ?></option>
													<?php }  ?>
												</select>
											</div>
										...
										<div class="row botones">
											...
											<div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2" ><a
												...
												<div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
													...
													class="btn btn-primary btn-block guardarPersona" id="campo[guardar]" disabled>
												</div>
											</div>
										</div>
									</div>
