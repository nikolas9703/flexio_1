        ...
        <div class="col-lg-12">
            <div class="wrapper-content" id="formulario">
                <div class="row">
                    ...
                    <div class="hide filtro-formularios" style="background-color: #D9D9D9; padding:6px 0 39px 10px">
                        ...
                        <div class="form-group col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <select id="formulario" class="white-bg chosen-filtro" role="tablist" disabled>
                                ...
                                <?php
                                if(!empty($tipos_intereses_asegurados)){
                                    foreach($tipos_intereses_asegurados AS $tipo){
                    ...
                    <?php
                    echo modules::run("intereses_asegurados/" . $tipo->valor. "formularioparcial");
                    ?>
                    </div>
                        <?php
                            }
...
echo Modal::config(array(
	...
	"contenido" => modules::run("intereses_asegurados/formularioModal", array())
))->html();
