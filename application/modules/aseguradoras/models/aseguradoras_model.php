...
class Aseguradoras_model extends CI_Model
{
    ...
    /**
     * Conteo de los aseguradoras existentes
     *
     * @return [array] [description]
     */
    function contar_aseguradoras($clause)
    {
        $fields = array (
            "cl.id_cliente"
        );
     ...
     * @return [array] [description]
     */
    function listar_aseguradoras($clause, $sidx = 1, $sord = 1, $limit = 0, $start = 0)
    {
        $i= 0;
        $result = array();
        $fields = array (
