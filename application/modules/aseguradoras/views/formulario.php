    ...
    <div class="tab-content">
        ...
        <div id="datosdelaaseguradora-5" class="col-lg-12">
            ...
            <div class="row"> <div class="col-xs-0 col-sm-6 col-md-8 col-lg-8">&nbsp;</div>
                ...
                <!--a href="<?php if($campos['ingreso'] != '' && $campos['ingreso'] == 'endosos' ){echo base_url('endosos/listar');}else{echo base_url('aseguradoras/listar');} ?>" class="btn btn-default btn-block" id="cancelar">Cancelar </a-->
