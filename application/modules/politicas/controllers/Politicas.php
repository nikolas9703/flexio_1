...
class Politicas extends CRM_Controller {
    ...
    protected $modulos = [
        ...
        ['id' => 'aseguradora', 'nombre' => 'Aseguradoras'],
        ['id' => 'ramos', 'nombre' => 'Ramos'],
        ['id' => 'ajustadores', 'nombre' => 'Ajustadores'],
        ['id' => 'agentes', 'nombre' => 'Agentes'],
        ['id' => 'intereses_asegurados', 'nombre' => 'Intereses asegurados'],
        ['id' => 'solicitudes', 'nombre' => 'Solicitudes'],
        ['id' => 'polizas', 'nombre' => 'Pólizas']
    ];
