...
class CotizacionesBitacoraMigation extends Migration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->schema->create('cotz_cotizaciones_historial', function(Illuminate\Database\Schema\Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('cotizacion_id')->index()->unsigned();
