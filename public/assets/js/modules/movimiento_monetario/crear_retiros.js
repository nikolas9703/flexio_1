...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    success: function(data){
         ...
         $('#cliente_proveedor').empty(); 
         $('.id_cliente_proveedor').empty(); 
         setTimeout(function(){
	 $('#cliente_proveedor').append('<option value='+ element.id +'>'+ element.nombre +'</option>').trigger('chosen:updated');
         $('.id_cliente_proveedor').val(element.id);
		}, 50);
...
$("#cliente_proveedor").change(function() {
    ...
    $('.id_cliente_proveedor').empty(); 
    $('.id_cliente_proveedor').val(cliente_proveedor);
