...
var ramos = {
  settings: {
    url: phost() + 'Configuracion_seguros/ajax_listar',
    grid_id : "#RamosGrid",
    grid_obj : $("#RamosGrid"),
 ...
 tablaGrid:function(){
   tablaRamos.grid_obj.jqGrid({
     ...
     {name: 'codigo_ramo',index:'codigo_ramo',sortable:false},
     {name:'id_tipo_int_asegurado',index:'id_tipo_int_asegurado',sortable:false},
     {name:'id_tipo_poliza',index:'id_tipo_poliza',sortable:false},
...
$(document).ready(function(){
  ...
  $.validator.setDefaults({
        errorPlacement: function(error, element) {
          console.log("initializig settings ...");
