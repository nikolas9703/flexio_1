    ...
    eventos: function () {
        ...
        tablaRamos.getRol.on("change", function () {
            ...
            if (tablaRamos.getRol.val()) {
                ...
                if ((tablaRamos.selectUsers.val() != null) && (tablaRamos.selectUsers.val() != "undefined") && (tablaRamos.selectUsers.val() != "")) {
                    var usuario_select = tablaRamos.selectUsers.val();
                     tablaRamos.selectUsers.empty();
                    usuario_seleccionado = {idUsuario: usuario_select};
                    console.log(usuario_seleccionado);
                    console.log(parametros);
                    var usuarios_seleccionado = moduloAseguradora.getUsuariosSeleccionado(usuario_seleccionado, parametros);
                    //console.log(respuesta_usuario);
                    var arrayusuario=[];
                    usuarios_seleccionado.done(function (data) {
                        var respuesta_user = $.parseJSON(data);
                        $.map(respuesta_user, function (item) {
                            arrayusuario.push(item.id);
                            console.log(arrayusuario);
                        });
                       

                    });
                    usuarios.val(arrayusuario).trigger("chosen:updated");
                }
        ...
        tablaRamos.opcionesModal.on("click", this.botones.editarCuenta, function (e) {
            ...
            buscarCuenta.success(function (data) {
                ...
                $('#id_ramo_catalogo').val(datos_ramo.id);
                ...
                tablaDocumentos.recargar(datos_ramo.id);
            ...
            buscarCuenta.done(function (data) {
                ...
                cuentas.done(function (data) {
                    ...
                    $("#treeRamos").on("changed.jstree", function (e, data) {
                        ...
                        $("#" + datos_cuenta.id + "_anchor").removeClass("jstree-clicked");
                        $("#" + datos_cuenta.padre_id + "_anchor").addClass("jstree-clicked");
                        //});
                    });
                }); // fin del done
