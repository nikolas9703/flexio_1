...
var tablaIngresos = (function(){
	...
	var url = 'planilla/ajax-listar-ingresos';
	...
	var botones = {
			...
			ExportarExcelBtn: "#ExportarExcelBtn",
			ExportarExcelBtn2: "#ExportarExcelBtn2",
     	};
  ...
  $(botones.ExportarExcelBtn).on("click", function(e){
          e.preventDefault();
          e.returnValue=false;
          e.stopPropagation();

          window.location.href =  phost() + 'planilla/exportar_csv_abierta?planilla_id='+planilla_id+'&tipo_planilla_creacion=regular'+'&colaborador_id='+colaborador_id;
  });

    $(botones.ExportarExcelBtn2).on("click", function(e){
            e.preventDefault();
            e.returnValue=false;
            e.stopPropagation();

            window.location.href =  phost() + 'planilla/exportar_csv_abierta2?planilla_id='+planilla_id+'&colaborador_id='+colaborador_id;
    });
	return{
		init: function() {
			//campos();
