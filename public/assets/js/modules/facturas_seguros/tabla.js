...
var tablaFacturas = (function () {
    ...
    var tabla = function () {
        gridObj.jqGrid({
            ...
            mtype: "POST",
            datatype: "json",
            colNames: ['', 'No.Factura', 'Cliente', 'No. Poliza', 'Pagador','Vigencia', 'Ramo', 'Fecha de emisión', 'Fecha de vencimiento', 'Monto', 'Saldo por cobrar', 'Sitio de Pago','Centro Contable', 'Estado',  '', ''],
            colModel: [
                ...
                {name: 'pagador', index: 'cli_clientes.nombre', sortable: true},
