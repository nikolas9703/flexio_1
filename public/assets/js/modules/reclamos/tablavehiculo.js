var tablaReclamosVehiculo = (function () {

    var unico = $("#detalleunico").val();
    var id_poliza = $("#poliza_seleccionado").val();
    if (id_poliza == "") { id_poliza = 0; }
    var tablaUrl = phost() + 'reclamos/ajax_listar_vehiculo';
    var gridId = "tablaReclamosVehiculo";
    var gridObj = $('#verModalIntereses').find("#tablaReclamosVehiculo");
    var opcionesModal = $('#verModalIntereses');
    var grid_obj = $("#tablaReclamosVehiculo");
    ...
    var tabla = function () {
        gridObj.jqGrid({
            ...
            loadBeforeSend: function () {//propiedadesGrid_cb
                ...
                $(this).closest("div.ui-jqgrid-view").find("#tablaReclamosVehiculoGrid_cb, #jqgh_tablaReclamosVehiculoGrid_link").css("text-align", "center");
            },
    ...
    var buscarReclamos = function () {
        ...
        var id_poliza = $('#poliza_seleccionado').val();
        if (id_poliza == "") { id_poliza = 0; }
        var chasis = $('#modal_chasis_vehiculo').val();
        var placa = $('#modal_placa_vehiculo').val();
        var operador = $('#modal_operador_vehiculo').val(); 

        if (id_poliza != "" || chasis != "" || placa != "" || operador != "" )
        {
            //Reload Grid
            grid_obj.setGridParam({
                url: phost() + 'reclamos/ajax_listar_vehiculo',
                datatype: "json",
                postData: {
                    numero: '',
                    certificado_detalle: '',
    ...
    var limpiarCampos = function () {
        console.log("limpiar");
        $('#modal_chasis_vehiculo').val('');
        $('#modal_placa_vehiculo').val('');
        $('#modal_operador_vehiculo').val('');
        recargar();
    };
...
$(function () {
    tablaReclamosVehiculo.init();
    $("#jqgh_tablaReclamosVehiculoGrid_cb span").removeClass("s-ico");
    $('#jqgh_tablaReclamosVehiculoGrid_options span').removeClass("s-ico");
});