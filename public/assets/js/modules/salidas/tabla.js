...
var tablaSalidas = (function(){
  ...
  if (this.hasOwnProperty('cliente_id')){
      client_uuid = this.cliente_id;
  }
    ...
    var muestra_tabla = function(){
        dom.jqGrid.jqGrid({
            ...
            colModel:[
                ...
                {name:'Destino', index:'destino', width:80, sortable:false},
                {name:'Enviar desde', index:'enviar_desde', width:80, sortable:false},
