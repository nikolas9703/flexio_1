...
var tablaUrl = phost() + 'pagos_contratos/ajax-listar';
        ...
        url: tablaUrl,
                mtype: "POST",
                datatype: "json",
                colNames:['', 'N&uacute;mero de pago', 'Fecha', 'Proveedor', 'No. Documento', 'Forma de Pago', 'Banco', 'Estado', 'Monto', '', ''],
                colModel:[
                ...
                postData: {
                erptkn: tkn,
                        proveedor: (typeof uuid_proveedor !== 'undefined') ? uuid_proveedor : '',
