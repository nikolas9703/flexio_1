...
bluapp.controller("entradaManualComentarioController", function($scope, $http, $sce){
  ...
  var rutas = {
    getComentario:  phost() + 'movimiento_monetario/ajax-getComentarioRetiros',
    postComentario:  phost() + 'movimiento_monetario/ajax-postComentarioRetiros'
  };
  $scope.comentarios = {
    comentario:''
  };
