...
bluapp.controller("entradaManualComentarioController", function($scope, $http, $sce){
  ...
  var rutas = {
    getComentario:  phost() + 'movimiento_monetario/ajax-getComentarioRecibos',
    postComentario:  phost() + 'movimiento_monetario/ajax-postComentarioRecibos'
  };
  $scope.comentarios = {
    comentario:''
  };
    ...
    if(formularioComentario.valid() === true){
      ...
      $http({
       ...
       if(data){
         ...
         console.log(data.data.comentario); 
