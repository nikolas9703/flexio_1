...
$(function() {
    ...
    //Init Contactos Grid
    $("#remesasGrid").jqGrid({
        url: phost() + 'remesas_entrantes/ajax-listar-remesas',
        datatype: "json",
        colNames:[
            'Nº de Remesa',
            'Fecha',
            'Archivo',
            'P&oacute;lizas Remesadas',
            'Usuarios',
            'Acci&oacute;n',
            ''
        ],
        colModel:[
            {name:'remesa', index:'remesa', width:70 },
            {name:'fecha', index:'fecha', width:70 },
            {name:'archivo', index:'archivo', width: 50 , sortable:false},
            {name:'poliza', index:'poliza', width: 50 , sortable:false},
