            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.success === true)
                    {
                        ...
                        toastr.success("¡&Eacute;xito! Se ha guardado correctamente el << Tipo de proveedor>>.");
                        limpiarFormulario();
                    }
                }
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.success === true)
                {
                    dom.iOptionsModal.modal("hide");
                    dom.jqGrid.trigger("reloadGrid");
                    toastr.success("¡&Eacute;xito! Se ha cambiado de estado correctamente el << Tipo de proveedor >>.");
                }
            }
