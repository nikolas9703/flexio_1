/**
 * Created by Ivan Cubilla on 5/12/16.
 */
/**
 * Created by Ivan Cubilla on 27/7/16.
 */
var tablaTiposDoc = (function(){
    ...
    var st = {
        ...
        guardarBtn: "#guardarTipoDocBtn",
        cancelarBtn: "#cancelarTipoDocBtn",
    ...
    var events = {
        ...
        eGuardar: function(e){
            ...
            $.ajax({
                url: phost() + st.segmento2 + "/ajax-guardar-tipos-documentos",
                type:"POST",
                data:{
                    erptkn:tkn,
                    uuid: uuid,
        ...
        eDesactivar: function(e){
            ...
            cambiarEstado(uuid, "20");
        },
        eActivar: function(e){
            var self = $(this);
            var uuid = self.data("uuid");

            cambiarEstado(uuid, "19");
        },
        eEditar: function(e){
            ...
            $.ajax({
                url: phost() + st.segmento2 + "/ajax-get-tipos-documentos",
                type:"POST",
                data:{
                    erptkn:tkn,
                    uuid: uuid
    ...
    var muestra_tabla = function(){
        dom.jqGrid.jqGrid({
            url: phost() + st.segmento2 + '/ajax-listar-tipos-documentos',
            datatype: "json",
            colNames:[
                'Tipo de documento',
                'Descripci&oacute;n',
            ...
            colModel:[
                ...
                {name:'Estatus', index:'estatus', width:60,  sortable:false, align:"center"},
            ...
            loadComplete: function(data){
                ...
                if( data['total'] == 0 ){
                    ...
                    dom.noRecords.empty().append('No se encontraron tipos de proveedor.').css({"color":"#868686","padding":"30px 0 0"}).show();
                }
                else{
                    dom.noRecords.hide();
    ...
    var cambiarEstado = function(uuid, estado){
        $.ajax({
            url: phost() + st.segmento2 + "/ajax-cambiar-estado-tipos-documentos",
            type:"POST",
            data:{
                erptkn:tkn,
                uuid: uuid,
