var tablaFacturasVentas = (function(){
    ...
    var tablaUrl = phost() + 'facturas/ajax-listar-de-item';
    ...
    var tabla = function(){
        ...
        gridObj.jqGrid({
            ...
            mtype: "POST",
            datatype: "json",
            colNames:['Fecha','Factura','Comprador','Estado','Cantidad','Precio','Total'],
            colModel:[
		{name:'Fecha', index:'created_at', width:50, sortable:false},
                {name:'Factura', index:'codigo', width:50, sortable:false},
		{name:'Comprador', index:'proveedor_id', width:70,  sortable:false, },
		...
		{name:'Total', index:'total', width: 50,  sortable:false}
            ...
            postData: {
                erptkn: tkn,
                //caja_id: scaja_id, falla el filtro desde otros modulos -> revisar
