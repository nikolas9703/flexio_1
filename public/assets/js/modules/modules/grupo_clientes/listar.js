...
var listarGrupoClientes = (function(){
    ...
    var st = {
        ...
        filename: "grupo_clientes",
        segmento2: "grupo_clientes",
        input: "input",

        //FORMULARIO DE BUSQUEDA
        chosens: "#nombre_cliente, #telefono, #email"
    ...
    var mostrar_mensaje = function(){
        ...
        /*if(mensaje_clase != 0)
        {
            ...
            {
                //toastr.success("¡&Eacute;xito! Se ha guardado correctamente el << Consumo/Inventario >>.");
            }
            else
            {
                toastr.error("¡Error! Su solicitud no fue procesada en el << Consumo/Inventario >>.");
            }
        }*/
    };
