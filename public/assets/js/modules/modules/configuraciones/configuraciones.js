  ...
  return{
    ...
    guardarNotificaciones:function(element){
      var parametros = $(element).serialize();
        return $.post(phost() +'configuracion/ajax-guardarNotificacion',parametros);
    },
    eliminarJob:function(parametros){
      return $.post(phost() +'configuracion/ajax-eliminar-job', $.extend({erptkn: tkn}, parametros));
    }
