var formulario43 = Vue.extend({
  template:'#formulario_43',
  data:function(){
    return {
      years:[],
      meses:[],
      reporte:{mes:'',year:'',tipo:'formulario43'},
      botonDisabled:false
    };
  },
  ready:function(){
    ...
    this.$http.post({
      ...
      method:'POST',
      data:{erptkn: tkn,formulario:'formulario43'}
  ...
  methods:{
    limpiar:function (){
      ...
      this.reporte={ mes:"",year:"",tipo:"formulario43"};
    ...
    generar_reporte:function(reporte){
      ...
      this.$http.post({
        ...
        reporteFinanciero.$set('reporte','reporte-formulario43');
      });
    }
  }
});
