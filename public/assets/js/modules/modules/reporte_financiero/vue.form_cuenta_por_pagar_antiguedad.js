...
var formCuentaPorPagarAntiguedad = Vue.extend({
  template:'#form_cuenta_por_pagar_antiguedad',
  data:function(){
    return {
      years:[],
      meses:[],
      reporte:{mes:'',year:'',tipo:'cuenta_por_pagar_por_antiguedad'},
      botonDisabled:false
    };
  },
  ready:function(){
    ...
    this.$http.post({
      ...
      method:'POST',
      data:{erptkn: tkn,formulario:'cuenta_por_pagar_por_antiguedad'}
  ...
  methods:{
    limpiar:function (){
      ...
      this.reporte={ mes:'',year:'',tipo:"cuenta_por_pagar_por_antiguedad"};
    ...
    generar_reporte:function(reporte){
      ...
      this.$http.post({
        ...
        reporteFinanciero.$set('reporte','reporte-cuenta-por-pagar-antiguedad');
      });
    }
  }
});
