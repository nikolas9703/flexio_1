...
var tablaHistorialAjustes = (function(){

    // Objeto al cual establecemos valores que vamos a usar mas adelante en este ambito.
    var st = {
        iOptionsModal:"#optionsModal",
        jqGridName: "historialAjustesGrid",
        jqGrid: "#historialAjustesGrid",
        jqPager: "#historialAjustesPager",
        optionsModal: "#optionsModal",
        noRecords: ".NoRecordsHistorialAjustes",
    ...
    var muestra_tabla = function(){
        dom.jqGrid.jqGrid({
            url: phost() + st.segmento2 + '/ajax-listar-historial-ajustes',
            datatype: "json",
            colNames:[
                'Fecha',
            ...
            colModel:[
                ...
                {name:'Nombre', index:'numero_ajuste', width:60,  sortable:false, align:"left"},
                {name:'Razon', index:'razon', width:120,  sortable:false, align:'left'},
                {name:'Estado', index:'estado', width:60,  sortable:false, align:'left'},
                {name:'Tipo', index:'tipo', width:60,  sortable:false, align:'left'},
