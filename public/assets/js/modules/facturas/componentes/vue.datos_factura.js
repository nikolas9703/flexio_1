    ...
    watch: {
        'factura.cliente_id': function (nv, ov) {
            ...
            this.$nextTick(function () {
                ...
                scope.factura.saldo_pendiente = roundNumber(parseFloat(cliente.saldo_pendiente.toString().replace(/,/g, '')), 2);

                //popular credito a favor
                scope.factura.credito_favor = roundNumber(parseFloat(cliente.credito_favor.toString().replace(/,/g, '')), 2);

                //popular dropdown centros de facturacion
                scope.factura.centrosFacturacionOptions = cliente.centro_facturable;
                setTimeout(function () {
