$(function(){
    ...
    $("#agentesGrid").jqGrid({
        ...
        colModel:[
            ...
            {name:'Telefono', index:'telefono', width:40,   sortable:false},
            {name:'Correo', index:'correo', width: 40,   sortable:false},
            {name:'porcentaje_participacion', index:'porcentaje_participacion', width: 30, sortable: false},
            {name:'estado', index:'estado', width: 40,   sortable:true},            
