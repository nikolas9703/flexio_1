var tablaAdendas = (function(){
    ...
    var tablaUrl = phost() + 'subcontratos/ajax-listar-adendas';
    ...
    var tabla = function(){
 	 gridObj.jqGrid({
 		 ...
 		 {name:'fecha',formatter: 'date', formatoptions: { srcformat: 'm/d/Y', newformat: 'd/m/Y'}, index:'fecha', width:50, sortable:true},
