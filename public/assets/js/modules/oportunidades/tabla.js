var tablaOportunidades = (function () {
    ...
    var tabla = function () {
        gridObj.jqGrid({
            ...
            mtype: "POST",
            datatype: "json",
            colNames: ['', 'No. Oportunidad', 'Nombre de la oportundad', 'Monto', 'Fecha de creaci&oacute;n', 'Asignado a', 'Etapa', '', ''],
            colModel: [
            ...
            loadComplete: function (data, status, xhr) {
                ...
                if (gridObj.getGridParam('records') === 0) {
                    $('#gbox_' + gridId).hide();
                    $('#' + gridId + 'NoRecords').empty().append('No se encontraron Oportunidades.').css({"color": "#868686", "padding": "30px 0 0"}).show();
                } else {
                    $('#gbox_' + gridId).show();
