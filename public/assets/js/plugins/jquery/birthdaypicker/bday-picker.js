  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='form-control-birtday birth-year' name='birth[year]'></select>"),
          $month = $("<select class='form-control-birtday birth-month' name='birth[month]'></select>"),
          $day = $("<select class='form-control-birtday birth-day' name='birth[day]'></select>");
