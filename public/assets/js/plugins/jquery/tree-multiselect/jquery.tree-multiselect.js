(function($) {
    ...
    function check() {
      ...
      sections.each(function() {
        ...
        if ($unselectedItems.length === 0) {
          ...
          //console.log("seleccione todos");
        }
        else
        {
          //console.log("no seleccione todos");
        }
      });
    }
  ...
  function updateSelectedAndOnChange($selectionContainer, $selectedContainer, $originalSelect, options) {
    function createSelectedDiv(selection) {
      ...
      //Edited by Francisco Marcano.
      if (options.groupable)
      {
          console.log("analizar logica y posibles casos");
      }
      ...
      if (!options.freeze && !options.groupable) {
