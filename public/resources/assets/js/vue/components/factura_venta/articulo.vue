     ...
     methods:{
         ...
         cambiarCategoria(event){
             ...
             //if(this.row.items.length === 0){
                 let datos = {categoria_id:categoria_id,erptkn: tkn};
        ...
        limpiarFila(){
            this.row = {categoria_id:'',items:[],unidades:[],unidad_id:'',item_id:'',atributos:[],cantidad:1, periodo_tarifario:'', tarifa:'', en_alquiler:0, precio_unidad:"0.00", impuesto_id:'', descuento:'0.00', cuenta_id:'', atributo_text:'', atributo_id:'', comentario:'',facturado:true, cuentas:[], tipo_id:'', por_entregar:0, entregado:0, devuelto:0,total_impuesto:0, total_descuento:0,impuesto:0,subtotal:0 }
        },
