...
Vue.component('items_factura', {
    ...
    data:function(){
        return {
            ...
            cuenta_transaccionales: typeof cuenta_transaccionales != 'undefined' ? $.parseJSON(cuenta_transaccionales) : []
        };
    },
    		...
    		if(ordendesde.match(/contrato_alquiler/gi)){
    			...
    			if(typeof this.$refs.items.$refs.items != 'undefined'){
    				impuesto_items_alquiler = _.sumBy(this.$refs.items.$refs.items.items, function(o){
    					return parseFloat((o.impuesto_porcentaje * o.precio_total)/100) || 0;
    	    	    });
    			}
	    		...
	    		if(typeof this.$refs.items.$refs.items_adicionales != 'undefined'){
	    			impuesto_items_adicionales = _.sumBy(this.$refs.items.$refs.items_adicionales.items, function(o){
						return parseFloat((o.impuesto_porcentaje * (o.precio_total- o.descuento))/100) || 0;
    	    	    });
	    		}
              ...
              impuestofloat = (porcentaje * (o.precio_total - o.descuento)) / 100;
              }
    				return parseFloat(impuestofloat);
    			});
    		}

			return typeof window.impuesto_total != 'undefined' && window.impuesto_total != '' ? window.impuesto_total : roundNumber(impuesto,2);
		},
        'descuento':function(){
        	var ordendesde = this.$root.$refs.filtro.ordendesde_id;
        	var descuento = 0;
    ...
    methods: {
    	...
    	*/
    	...
    	popularUnidadAtributo: function(e, item, index){
            ...
            var scope = this;
            var item_id 		= $(e.currentTarget).find('option:selected').val();
            var categoria 		= _.find(scope.categorias, function(categoria){ return categoria.id == item.categoria_id; });
            var iteminfo 		= typeof categoria != 'undefined' ? _.find(categoria.items, function(iteminfo){ return iteminfo.id == item_id; }) : '';
            var precio_unidad 	= '';
