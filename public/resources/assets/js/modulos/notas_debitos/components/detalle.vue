<template>
    ...
    <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <select name="campo[proveedor_id]" class="form-control" data-rule-required="true"
            v-select2ajax="detalle.proveedor_id" :config="select2proveedor" :disabled="config.disableDetalle || empezable.type != ''">
  ...
  props:{
    ...
    watch:{
        ...
        'empezable.id': function(val, oldVal){
            var context = this;
            var datos = $.extend({erptkn: tkn},{factura_id:val});
          ...
          getEstados: function (){
              ...
              if(context.config.vista == 'ver')
              {
                   ...
                   if(nota_debito.estado == 'aprobado')
                  {
                      ...
                      return _.filter(context.catalogos.estados, function(estado){return estado.etiqueta == 'anulado';});
                  }
              }
