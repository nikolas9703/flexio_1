...
export default {
  ...
  props:{
        ...
        return {
            ...
            jqgrid:{
            	...
            	colModel:[
            		...
            		{name:'nombre_item', index:'nombre_item', width:70, sortable:false},
            		{name:'adquisicion', index:'adquisicion', width:70, sortable:false},
                    {name:'otros_costos', index:'otros_costos', width:70, sortable:false},
                    {name:'valor_actual', index:'valor_actual', width:70, sortable:false},
                    {name:'ult_movimiento', index:'ult_movimiento', width:70, sortable:false},
                    {name:'ubicacion', index:'ubicacion', width:70, sortable:false},
            		{name:'estado', index:'estado', width: 50, align:"center", sortable:false},
    ...
    methods: {
        ...
        loadComplete: function(data){
            ...
            if( data['total'] == 0 ){
                ...
                $('#'+ context.dom.no_records_id).empty().append('No se encontraron Series.').css({"color":"#868686","padding":"30px 0 0"}).show();
            }else{
    ...
    ready: function(){
        ...
        //como ejemplo
    	$('#'+ context.dom.modal_id).on("click", ".editarUsuarioBtn", function(e){
            context.prevent(e);
