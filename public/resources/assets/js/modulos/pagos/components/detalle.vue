    ...
    <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="campo[fecha_pago]" class="form-control" aria-required="true" data-rule-required="true" v-datepicker="detalle.fecha_pago" :config="config.datepicker2" :disabled="config.disableDetalle">
            </div>
        ...
        <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <select name="campo[proveedor_id]" class="" aria-required="true" data-rule-required="true" v-select2="detalle.proveedor_id" :config="config.select2" :disabled="true">
              <option value="">Seleccione</option>
              <option :value="proveedor.proveedor_id" v-for="proveedor in catalogos.proveedoresList">{{proveedor.nombre}}</option>
            </select>
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3" v-if="config.vista == 'crear'">
            ...
            <div class="input-group">
                ...
                <input type="text" disabled value="{{detalle.saldo_proveedor| currency ''}}" class="form-control debito">
            </div>
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3 " v-if="config.vista == 'crear'">
            ...
            <div class="input-group">
                <span class="input-group-addon">$</span>
                <input type="text" disabled value="{{detalle.credito_proveedor | currency ''}}" class="form-control debito">
            </div>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3" v-show="config.vista != 'crear'">
            ...
            <select name="campo[estado]" class="estado" aria-required="true" data-rule-required="true" v-select2="detalle.estado" :config="config.select2" :disabled="config.vista == 'crear' || (config.vista != 'crear' && !sePuedeCambiarEstado)">
                <option value="">Seleccione</option>
          ...
          'detalle.proveedor_id':function(val, oldVal){
              ...
              this.$http.post({
                  ...
                  if(!_.isEmpty(response.data)){
                      ...
                      if(!_.isEmpty(proveedor) && !_.isEmpty(context.detalle.metodos_pago[0].referencia))
                      {
