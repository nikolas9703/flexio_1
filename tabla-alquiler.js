...
var _fechas = require('./config/fechas');

var _fechas2 = _interopRequireDefault(_fechas);
...
//Vue.component('empezar-desde',require('./vue/components/empezable-desde.vue'));
var formulario = {
  cliente_id: '',
...
var vmTablaAlquilar = new Vue({
  ...
  data: {
    ...
    catalogoFormulario: { centro_contables: [], estados: [], terminos_pagos: [], vendedores: [], centro_facturable: [], articulos: [] },
    tablaItem: [],
    formulario: formulario,
    configDatepicker: _fechas2.default,
    catClientes: _clientes2.default,
    comentarios: [],
    campoDisabled: {
  ...
  methods: {
    ...
    cargarCatalogoDefault: function cargarCatalogoDefault() {
      var datos = { erptkn: tkn };
      var catalogos = this.postAjax('ajax_catalogo/catalogos_ventas', datos);
      var self = this;
      catalogos.then(function (response) {
        ...
        self.$nextTick(function () {
          ...
          if (self.config.vista === "crear") {
            self.tablaItem = _items2.default.items;
    ...
    setData: function setData(cotizacion) {
      _clientes2.default.catalogo.tipo = cotizacion.cliente_tipo;
      _clientes2.default.catalogo.cliente_id = cotizacion.cliente_id;
      ...
      _items2.default.items = cotizacion.items;
      this.tablaItem = cotizacion.items;
      this.comentarios = cotizacion.landing_comments;
    }
  },
  watch: {
    'catClientes.catalogo.cliente_id': function catClientesCatalogoCliente_id(val, oldVal) {
      ...
      if (this.config.vista === 'crear') {
        ...
        if (_clientes2.default.catalogo.tipo === 'cliente' && !_.isEmpty(val)) {
          //se popula saldo, credito,los centros facturables
          var cliente_actual = _.find(_clientes2.default.catalogo.clientes, function (query) {
            return query.id == val;
          });
    ...
    'catClientes.catalogo.clientes': function catClientesCatalogoClientes(val, oldVal) {
      if (val.length > 0 && this.config.vista === 'editar') {
        var valcliente = _clientes2.default.catalogo.cliente_id;
        this.formulario.cliente_id = valcliente;

        if (_clientes2.default.catalogo.tipo === 'cliente') {
          var cliente_actual = _.find(val, function (query) {
            return query.id == valcliente;
          });
...
},{"./clientes":70,"./config/fechas":71,"./items":72,"./mixin_guardar_item_alquiler":73,"./vue/components/comentario.vue":76,"./vue/components/empezable-desde.vue":77,"./vue/components/tabla-articulos.vue":78}],75:[function(require,module,exports){
'use strict';
...
exports.default = {
    props: ['detalle', 'catalogos', 'parent_index', 'row', 'empezable', 'mostrar', 'desabilitar', 'configv'],
    data: function data() {
    ...
    computed: {
        ...
        getImpuestoTotal: function getImpuestoTotal() {
        ...
        getRetenidoTotal: function getRetenidoTotal() {
            var context = this;
            var impuesto = _.find(context.catalogos.impuestos, function (impuesto) {
                return impuesto.id == context.row.impuesto_id;
            });
        ...
        getDescuentoTotal: function getDescuentoTotal() {
            var context = this;
            return context.getSubtotal * context.row.descuento / 100;
        },
        tieneAtributos: function tieneAtributos() {
            return this.row.atributos.length > 0;
        }
    },
    methods: {
        changeCaret: function changeCaret() {

            this.fa_caret = this.fa_caret === 'fa-caret-right' ? 'fa-caret-down' : 'fa-caret-right';
        },
        encontrarCategoria: function encontrarCategoria() {
            var context = this;
            return _.find(this.catalogos.categorias, function (query) {
                return query.id == context.row.categoria_id;
            });
        },
        encontrarIndexCategoria: function encontrarIndexCategoria(categoria) {
            return _.findIndex(this.catalogos.categorias, categoria);
        },
        setRow: function setRow() {
            this.isCambiaItem();
            var context = this;
            var item = _.find(context.row.items, function (query) {
                return query.id == context.row.item_id;
            });
        ...
        setTarifa: function setTarifa() {
            var context = this;
            var catalogo_tarifa = { por_hora: 'tarifa_hora', diario: 'tarifa_diario', mensual: 'tarifa_mensual' };
            var tipo_tarifa = catalogo_tarifa[context.row.periodo_tarifario];
            var item = _.find(context.row.items, function (query) {
                return query.id == context.row.item_id;
            });
            context.row.precio_unidad = item[tipo_tarifa];
        },
        addRow: function addRow() {

            _items2.default.items.push({
                id: '',
                cantidad: '1',
                categoria_id: '',
                cuenta_id: '',
        ...
        removeRow: function removeRow(row) {
            ...
            _items2.default.items.$remove(row);
        },
        getItems: function getItems(categoria_id) {
            if (!_.isInteger(this.row.item_hidden)) {
                this.cambiarCategoria();
            }
            var context = this;
            var categoria = _.find(this.catalogos.categorias, function (query) {
                return query.id == context.row.categoria_id;
            });
        ...
        getItemsAjax: function getItemsAjax(categoria_id) {
        ...
        cambiarCategoria: function cambiarCategoria() {
            if (!_.isEmpty(this.row.categoria_id)) this.row.items = [];
        ...
        isCambiaItem: function isCambiaItem() {
            if (_.isEmpty(this.row.item_id) && !_.isInteger(this.row.item_hidden)) {
                this.row.atributos = [];
                this.row.cuenta_id = '';
                this.row.impuesto_id = '';
            }
        ...
        setCantidad: function setCantidad(cantidad) {
            if (parseInt(cantidad) === 0) this.row.cantidad = 1;
        },
        setPrecioUnitario: function setPrecioUnitario(precio) {
            this.row.precio_unidad = precio;
        }
    },
    watch: {
        'row.categoria_id': function rowCategoria_id(val, oldVal) {
        ...
        'row.item_id': function rowItem_id(val, oldVal) {
        ...
        'row.periodo_tarifario': function rowPeriodo_tarifario(val, oldVal) {
            if (!_.isEmpty(val)) {
                this.setTarifa();
                return;
            }
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<tr :style=\"(row.facturado || configv.vista == 'crear') ? 'background:white;' : 'background:orange;'\" class=\"animated\" transition=\"listado\">\n\n    <td style=\"background: white;\">\n        <i class=\"fa\" :class=\"fa_caret\" style=\"font-size: 28px;width: 10px;\" @click=\"changeCaret\"></i>\n        <input type=\"hidden\" name=\"items[{{parent_index}}][id]\" class=\"item_hidden\" id=\"id{{parent_index}}\" value=\"{{row.id}}\">\n    </td>\n\n    <td class=\"categoria{{parent_index}} \">\n        <select name=\"items[{{parent_index}}][categoria_id]\" class=\"categoria select2\" id=\"categoria{{parent_index}}\" data-rule-required=\"true\" aria-required=\"true\" v-model=\"row.categoria_id\" v-select3=\"row.categoria_id\" :config=\"config.select2\" :disabled=\"config.disableArticulos || disabledArticulo\" @change=\"getItems(row.categoria_id)\">\n            <option value=\"\">Seleccione</option>\n            <option :value=\"categoria.id\" v-for=\"categoria in catalogos.categorias\">{{categoria.nombre}}</option>\n        </select>\n    </td>\n\n    <td class=\"item{{parent_index}} \">\n        <input type=\"hidden\" name=\"items[{{parent_index}}][item_hidden]\" class=\"item_hidden\" id=\"item_hidden{{parent_index}}\" v-model=\"row.item_hidden_id\">\n        <input type=\"hidden\" id=\"comentario{{parent_index}}\" name=\"items[{{parent_index}}][comentario]\" value=\"{{row.comentario}}\">\n        <div class=\"input-group\">\n         <select name=\"items[{{parent_index}}][item_id]\" class=\"item select2\" id=\"item{{parent_index}}\" data-rule-required=\"true\" aria-required=\"true\" v-model=\"row.item_id\" v-select3=\"row.item_id\" :config=\"config.select2\" :disabled=\"config.disableArticulos || disabledArticulo\">\n            <option :value=\"item.id\" v-for=\"item in row.items\">{{item.nombre}}</option>\n        </select>\n        <span class=\"input-group-btn\">\n            <a id=\"boton{{parent_index}}\" type=\"button\" class=\"btn btn-default\" rel=\"popover\" v-item-comentario=\"row.comentario\" :i=\"parent_index\" :comentado=\"row.comentario\"> <span class=\"fa fa-comment\"></span></a>\n        </span>\n    </div>\n    </td>\n\n    <td class=\"atributo{{parent_index}} \">\n        <input type=\"text\" name=\"items[{{parent_index}}][atributo_text]\" class=\"form-control atributo\" id=\"atributo_text{{parent_index}}\" v-if=\"!tieneAtributos\" v-model=\"row.atributo_text\" :disabled=\"config.disableArticulos || disabledArticulo\">\n        <select name=\"items[{{parent_index}}][atributo_id]\" class=\"atributo\" id=\"atributo_id{{parent_index}}\" v-if=\"tieneAtributos\" v-model=\"row.atributo_id\" v-select3=\"row.atributo_id\" :config=\"config.select2\" :disabled=\"config.disableArticulos || disabledArticulo\">\n            <option value=\"\">Seleccione</option>\n            <option :value=\"atributo.id\" v-for=\"atributo in row.atributos\">{{atributo.nombre}}</option>\n        </select>\n    </td>\n\n <td class=\"cantidad{{parent_index}}\"> <!--:class=\"mostrar.icono_pop_over?'input-group':''\" -->\n        <input type=\"text\" name=\"items[{{parent_index}}][cantidad]\" class=\"form-control cantidad valid\" data-rule-required=\"true\" aria-required=\"true\" id=\"cantidad{{parent_index}}\" v-model=\"row.cantidad\" v-inputmask3=\"row.cantidad\" :config=\"config.inputmask.numero\" :disabled=\"config.disableArticulos || disabledArticulo\">\n        <span v-if=\"mostrar.icono_pop_over\" class=\"input-group-addon cantidad_info\" style=\"background-color:#27AAE1;color:white;border:1px solid #27AAE1\" v-pop_over_cantidad=\"\"><i class=\"fa fa-info\"></i></span>\n    </td>\n\n\n    <td class=\"periodo_tarifario{{parent_index}} \">\n\n            <select id=\"periodo_tarifario{{parent_index}}\" name=\"items[{{parent_index}}][periodo_tarifario]\" v-select3=\"row.periodo_tarifario\" :config=\"config.select2\" class=\"form-control select2\" data-rule-required=\"true\" v-model=\"row.periodo_tarifario\" :disabled=\"disabledEditar || disabledEditarTabla\">\n                <option value=\"\">Seleccione</option>\n                <option value=\"{{ciclo.valor}}\" v-for=\"ciclo in catalogos.periodos_tarifario\">{{ciclo.nombre}}</option>\n            </select>\n\n    </td>\n\n    <td class=\"precio_unidad{{parent_index}} \">\n        <div class=\"input-group\">\n            <span class=\"input-group-addon\"><i class=\"fa fa-dollar\"></i></span>\n            <input type=\"text\" name=\"items[{{parent_index}}][precio_unidad]\" v-model=\"row.precio_unidad\" class=\"form-control precio_total moneda\" id=\"precio_unidad{{parent_index}}\" agrupador=\"items\">\n            <input type=\"hidden\" name=\"items[{{parent_index}}][impuesto_total]\" value=\"{{getImpuestoTotal | currency ''}}\" class=\"form-control impuesto_total\" id=\"impuesto_total{{parent_index}}\">\n            <input type=\"hidden\" name=\"items[{{parent_index}}][descuento_total]\" value=\"{{getDescuentoTotal | currency ''}}\" class=\"form-control descuento_total\" id=\"descuento_total{{parent_index}}\">\n             <!-- <input type=\"hidden\" name=\"items[{{parent_index}}][retenido_total]\" value=\"{{getRetenidoTotal | currency ''}}\" class=\"form-control retenido_total\" id=\"retenido_total{{parent_index}}\" > -->\n        </div>\n    </td>\n\n    <td style=\"background: white;\">\n        <button type=\"button\" class=\"btn btn-default btn-block agregarBtn\" agrupador=\"items\" label=\"<i class=&quot;fa fa-plus&quot;></i>\" v-if=\"parent_index=='0'\" @click=\"addRow()\" :disabled=\"config.disableArticulos || disabledArticulo\"><i class=\"fa fa-plus\"></i></button>\n        <button type=\"button\" class=\"btn btn-default btn-block eliminarBtn\" agrupador=\"items\" label=\"<i class=&quot;fa fa-trash&quot;></i>\" v-if=\"parent_index!='0'\" @click=\"removeRow(row)\" :disabled=\"config.disableArticulos || disabledArticulo\"><i class=\"fa fa-trash\"></i></button>\n        <input type=\"hidden\" name=\"items[{{parent_index}}][id_pedido_item]\" value=\"\" class=\"form-control\" id=\"id_pedido_item\">\n    </td>\n\n</tr>\n\n<tr v-show=\"fa_caret == 'fa-caret-down'\">\n    <td></td>\n    <td colspan=\"6\" style=\"padding:0\">\n        <table style=\"width: 100%;background: #A2C0DA;\">\n\n            <tbody><tr><td class=\"impuesto_id{{parent_index}}\" width=\"33%\" style=\"padding: 10px;\">\n                <label>Impuesto</label>\n                <select name=\"items[{{parent_index}}][impuesto_id]\" class=\"impuesto select2\" id=\"impuesto_id{{parent_index}}\" data-rule-required=\"true\" aria-required=\"true\" v-model=\"row.impuesto_id\" v-select3=\"row.impuesto_id\" :config=\"config.select2\" :disabled=\"config.disableArticulos || disabledArticulo\">\n                    <option value=\"\">Seleccione</option>\n                    <option :value=\"impuesto.id\" v-for=\"impuesto in catalogos.impuestos\">{{impuesto.nombre}}</option>\n                </select>\n            </td>\n\n            <td class=\"descuento{{parent_index}}\" width=\"33%\" style=\"padding: 10px;\">\n                <label>Descuento</label>\n                <div class=\"input-group\" style=\"width: 100%;\">\n                    <input type=\"input-right-addon\" name=\"items[{{parent_index}}][descuento]\" class=\"form-control descuento\" id=\"descuento{{parent_index}}\" agrupador=\"items\" v-model=\"row.descuento\" v-porcentaje=\"row.descuento\" :config=\"config.inputmask.porcentaje\" :disabled=\"config.disableArticulos || disabledArticulo\">\n                    <span class=\"input-group-addon\">%</span>\n                </div>\n            </td>\n\n            <td class=\"cuenta{{parent_index}}\" width=\"33%\" style=\"padding: 10px;\">\n                <label>{{config.vista == 'crear' ? 'Cuenta' : 'Cuenta'}}</label>\n                <select name=\"items[{{parent_index}}][cuenta_id]\" class=\"cuenta select2\" id=\"cuenta{{parent_index}}\" data-rule-required=\"true\" aria-required=\"true\" v-model=\"row.cuenta_id\" v-select3=\"row.cuenta_id\" :config=\"config.select2\" :disabled=\"config.disableArticulos || disabledArticulo\">\n                    <option value=\"\">Seleccione</option>\n                    <option :value=\"cuenta.id\" v-for=\"cuenta in catalogos.cuentas\">{{cuenta.codigo +' '+ cuenta.nombre}}</option>\n                </select>\n            </td>\n\n        </tr></tbody></table>\n    </td>\n    <td></td>\n</tr>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7b11331f", module.exports)
  } else {
    hotAPI.update("_v-7b11331f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../../js/items":72,"vue":68,"vue-hot-reload-api":67}],76:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n.white-bg[_v-1][_v-3d2ccfb6]{\n    padding-top: 15px;\n}\n")
'use strict';
...
var _metodos_comentario = require('./../mixins/metodos_comentario');

var _metodos_comentario2 = _interopRequireDefault(_metodos_comentario);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
  mixins: [_metodos_comentario2.default],
    ...
    if (this.vista == 'editar' || this.vista == 'ver') {
      this.$nextTick(function () {
        CKEDITOR.replace('tcomentario', {
          toolbar: [{ name: 'basicstyles', items: ['Bold', 'Italic'] }, { name: 'paragraph', items: ['NumberedList', 'BulletedList'] }],
          uiColor: '#F5F5F5'
        });
      });
    }
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"row col-xs-12 col-sm-12 col-md-12 col-lg-12 m-t-md white-bg\" _v-1=\"\" _v-3d2ccfb6=\"\">\n  <div class=\"col-xs-12 col-sm-12 col-md-6 col-lg-6\" _v-3d2ccfb6=\"\">\n    <label for=\"comentario\" _v-3d2ccfb6=\"\">Comentario</label>\n      <textarea rows=\"5\" cols=\"10\" name=\"modulo[comentario]\" id=\"tcomentario\" data-rule-required=\"true\" v-model=\"comentario\" _v-3d2ccfb6=\"\">\n\n      </textarea>\n\n      <label id=\"comentario-error\" class=\"error\" for=\"comentario\" _v-3d2ccfb6=\"\"></label>\n      <div class=\"row\" _v-3d2ccfb6=\"\">\n        <div class=\"form-group col-xs-12 col-sm-12 col-md-6 col-lg-6\" _v-3d2ccfb6=\"\"></div>\n        <div class=\"form-group col-xs-12 col-sm-12 col-md-3 col-lg-3\" _v-3d2ccfb6=\"\">\n          <button class=\"btn btn-default btn-block\" id=\"cancelarFormBtn\" v-on:click=\"limpiarEditor()\" _v-3d2ccfb6=\"\">Limpiar</button>\n        </div>\n        <div class=\"form-group col-xs-12 col-sm-12 col-md-3 col-lg-3\" _v-3d2ccfb6=\"\">\n          <button id=\"guardar_comentario\" class=\"btn btn-primary btn-block\" v-on:click=\"guardar_comentario()\" _v-3d2ccfb6=\"\">Comentar</button>\n        </div>\n      </div>\n    </div>\n\n  <div class=\"col-xs-12 col-sm-12 col-md-6 col-lg-6\" _v-3d2ccfb6=\"\">\n      <label for=\"comentario\" _v-3d2ccfb6=\"\">Historial</label>\n      <div id=\"historial_comentario\" _v-3d2ccfb6=\"\">\n        <div class=\"ibox-content\" _v-3d2ccfb6=\"\">\n          <div class=\"vertical-container dark-timeline center-orientation\" _v-3d2ccfb6=\"\">\n             <div class=\"vertical-timeline-block animated\" v-for=\"item in historial | orderBy 'id' -1\" transition=\"listado\" _v-3d2ccfb6=\"\">\n                                <div class=\"vertical-timeline-icon blue-bg\" _v-3d2ccfb6=\"\">\n                                    <i class=\"fa fa-comments-o\" _v-3d2ccfb6=\"\"></i>\n                                </div>\n\n                                <div class=\"vertical-timeline-content\" _v-3d2ccfb6=\"\">\n                                  <h2 _v-3d2ccfb6=\"\">Comentó</h2>\n                                  <div v-html=\"item.comentario\" _v-3d2ccfb6=\"\"></div>\n\n                                    <span class=\"vertical-date\" _v-3d2ccfb6=\"\">\n                                      {{item.cuanto_tiempo}} <br _v-3d2ccfb6=\"\">\n                                      <small _v-3d2ccfb6=\"\">{{ item.fecha_creacion}}</small>\n                                        <div _v-3d2ccfb6=\"\"><small _v-3d2ccfb6=\"\">{{item.nombre_usuario}} @ {{ item.hora}}</small></div>\n                                    </span>\n                                </div>\n                  </div>\n\n\n          </div>\n        </div>\n      </div>\n  </div>\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3d2ccfb6", module.exports)
  } else {
    hotAPI.update("_v-3d2ccfb6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../mixins/metodos_comentario":79,"vue":68,"vue-hot-reload-api":67,"vueify/lib/insert-css":69}],77:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 2, stdin */\n.header-empezable {\n  background-color: #D9D9D9;\n  padding: 6px 0; }\n  /* line 5, stdin */\n  .header-empezable div.text-header {\n    padding-top: 8px;\n    font-size: 14px;\n    font-weight: bolder;\n    color: #666666; }\n")
'use strict';
...
var _clientes = require('../../../js/clientes');
...
exports.default = {
    ...
    computed: {
        ...
        getOpciones: function getOpciones() {
            return this.options;
        },
    ...
    methods: {
        fillCatalogo: function fillCatalogo() {
            var datos = { erptkn: tkn };
            var catalogo = this.getCatalogo(datos);
            var self = this;
            catalogo.then(function (response) {
                if (_.has(response.data, 'session')) {
                    window.location.assign(window.phost());
                    return;
                }
        ...
        getCatalogo: function getCatalogo(datos) {
        ...
        pruebas: function pruebas(key, value) {
    ...
    watch: {
        'empezable_type': function empezable_type(val, oldVal) {
        ...
        'empezable_id': function empezable_id(val, oldVal) {
            if (this.info.vista === "crear") {
                this.catClientes.catalogo.cliente_id = val;
            }
        },
        'catClientes.catalogo.tipo': function catClientesCatalogoTipo(val, oldVal) {
            if (this.info.vista === "editar") {
                this.empezable_type = _clientes2.default.catalogo.tipo;
                this.fillCatalogo();
            }
        }
    }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1b719e89", module.exports)
  } else {
    hotAPI.update("_v-1b719e89", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../../js/clientes":70,"babel-runtime/core-js/promise":1,"vue":68,"vue-hot-reload-api":67,"vueify/lib/insert-css":69}],78:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
    ...
    methods: {
        setArticulosItems: function setArticulosItems() {
            var self = this;
            //setTimeout(function(){
            self.$set('articulos', _items2.default.items);
            //},1500);
        },
        getArticulosCatalogos: function getArticulosCatalogos() {
            var self = this;
        ...
        getSubtotalArticulo: function getSubtotalArticulo(articulo) {

            return articulo.cantidad * articulo.precio_unidad;
        },

        getDescuentoArticulo: function getDescuentoArticulo(articulo) {

            return this.getSubtotalArticulo(articulo) * articulo.descuento / 100;
        },

        getImpuestoArticulo: function getImpuestoArticulo(articulo) {
        ...
        getRetenidoArticulo: function getRetenidoArticulo(articulo) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5dbef3be", module.exports)
  } else {
    hotAPI.update("_v-5dbef3be", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../../js/items":72,"./articulo.vue":75,"vue":68,"vue-hot-reload-api":67,"vueify/lib/insert-css":69}],79:[function(require,module,exports){
"use strict";
...
exports.default = {
    methods: {
        limpiarEditor: function limpiarEditor() {
            CKEDITOR.instances.tcomentario.setData('');
        },
        guardar_comentario: function guardar_comentario() {
...
//# sourceMappingURL=tabla-alquiler.js.map
